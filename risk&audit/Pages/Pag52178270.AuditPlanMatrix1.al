page 50108 "Audit Plan Matrix 1"
{
    ...
    begin
        ...
        IF AuditPeriod.GETFILTER("Global Dimension 1 Filter") <> '' THEN
            GlobalDim1Filter := AuditPeriod.GETFILTER("Global Dimension 1 Filter");
        IF AuditPeriod.GETFILTER("Global Dimension 2 Filter") <> '' THEN
            GlobalDim2Filter := AuditPeriod.GETFILTER("Global Dimension 2 Filter");
        ...
        CASE DimOption OF
            ...
            DimOption::Period:
                BEGIN
                    ...
                    IF Found THEN
                        CopyPeriodToBuf(Period, AuditPeriod);
                END;
            DimOption::"Business Unit":
                BEGIN
