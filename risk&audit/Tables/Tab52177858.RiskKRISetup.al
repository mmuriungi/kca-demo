table 52177858 "Risk KRI Setup"
{
    ...
    begin
        ...
        if "Employee No" = '' then
            NoSeriesMgt.InitSeries(RiskSetup."Risk KRI Guideline Nos", xRec."No. Series", 0D, "Employee No", "No. Series");
    end;


    var
        TriggerError: Label 'The range should be between 1 and 7';
