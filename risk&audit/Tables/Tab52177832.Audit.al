table 52177832 Audit
{
    ...
    fields
    {
        ...
        field(5; "Audit Dimension 1 Code"; Code[20])
        {
            ...
            trigger OnValidate()
            begin
                IF "Audit Dimension 1 Code" <> xRec."Audit Dimension 1 Code" THEN
                    IF Dim.CheckIfDimUsed("Audit Dimension 1 Code", 9, Code, '', 0) THEN
        ...
        field(6; "Audit Dimension 2 Code"; Code[20])
        {
            ...
            trigger OnValidate()
            begin
                IF "Audit Dimension 2 Code" <> xRec."Audit Dimension 2 Code" THEN
                    IF Dim.CheckIfDimUsed("Audit Dimension 2 Code", 10, Code, '', 0) THEN
                        ERROR(Text000, Dim.GetCheckDimErr);
            end;
        }
        field(7; "Audit Dimension 3 Code"; Code[20])
        {
            ...
            trigger OnValidate()
            begin
                IF "Audit Dimension 3 Code" <> xRec."Audit Dimension 3 Code" THEN
                    IF Dim.CheckIfDimUsed("Audit Dimension 3 Code", 11, Code, '', 0) THEN
                        ERROR(Text000, Dim.GetCheckDimErr);
            end;
        }
        field(8; "Audit Dimension 4 Code"; Code[20])
        {
            ...
            trigger OnValidate()
            begin
                IF "Audit Dimension 4 Code" <> xRec."Audit Dimension 4 Code" THEN
                    IF Dim.CheckIfDimUsed("Audit Dimension 4 Code", 12, Code, '', 0) THEN
                        ERROR(Text000, Dim.GetCheckDimErr);
            end;
        }
    }
