...
Table 77344 "ACA-Arch. Room Alloc. Details"
{
    ...
    fields
    {
        ...
        field(3; "Hostel Block"; Code[20])
        {
        }
        field(4; "Imported By"; Code[20])
        {
        }
        field(5; "Date Imported"; Date)
        {
        }
        ...
        field(8; "Student Name"; Text[150])
        {
        }
        field(9; "Room No"; Code[20])
        {
        }
        field(10; "Room Space"; Code[20])
        {
        }
        field(11; "Notification Send"; Boolean)
        {
        }
        field(12; "posted to Hostels?"; Boolean)
        {
        }
        field(13; "Room Cost"; Decimal)
        {
        }
        field(14; "Phone Number"; Text[50])
        {
        }
        field(15; "Email Address"; Text[150])
        {
        }
        ...
        field(21; "Exists in Student List"; Boolean)
        {
            CalcFormula = exist(Customer where("No." = field("Student No.")));
            FieldClass = FlowField;
        }
        field(22; Credits; Decimal)
        {
    ...
    begin
        ...
        if ACAStudentsHostelRooms12.Find('-') then begin
            ...
            ACAStudentsHostelRooms12.TestField(Allocated, false);
            if Cust.Get(ACAStudentsHostelRooms12.Student) then begin
            ...
            if Cust."Hostel Black Listed" = false then begin
                ...
                Creg1.Reset;
                Creg1.SetRange(Creg1."Student No.", ACAStudentsHostelRooms12.Student);
                Creg1.SetRange(Creg1.Semester, ACAStudentsHostelRooms12.Semester);
                ...
                // Assign Items
                hostcard.Reset;
                hostcard.SetRange(hostcard."Asset No", ACAStudentsHostelRooms12."Hostel No");
                if hostcard.Find('-') then begin
                    ...
                    if invItems.Find('-') then begin
                        studItemInv.Reset;
                        studItemInv.SetRange(studItemInv."Student No.", ACAStudentsHostelRooms12.Student);
                        studItemInv.SetRange(studItemInv.Semester, ACAStudentsHostelRooms12.Semester);
                        if studItemInv.Find('-') then studItemInv.DeleteAll;
                        repeat
                        begin
                            studItemInv.Init;
                            studItemInv."Hostel Block" := ACAStudentsHostelRooms12."Hostel No";
                            studItemInv."Room Code" := ACAStudentsHostelRooms12."Room No";
                            studItemInv."Space Code" := ACAStudentsHostelRooms12."Space No";
                            studItemInv."Item Code" := invItems.Item;
                            studItemInv."Academic Year" := ACAStudentsHostelRooms12."Academic Year";
                            studItemInv.Semester := ACAStudentsHostelRooms12.Semester;
        ...
        if StudentHostel.Find('-') then begin
            repeat
                ...
                if Rooms_Spaces.Find('-') then begin
                    ...
                    Host_Ledger."Student No" := ACAStudentsHostelRooms.Student;
                    Host_Ledger."Receipt No" := '';
                    Host_Ledger.Semester := ACAStudentsHostelRooms.Semester;
                    Host_Ledger.Gender := Gender;
                    Host_Ledger."Hostel Name" := '';
                    Host_Ledger.Campus := Cust."Global Dimension 1 Code";
                    Host_Ledger."Academic Year" := ACAStudentsHostelRooms."Academic Year";
                    Host_Ledger.Insert(true);


                    Hostel_Rooms.Reset;
                    Hostel_Rooms.SetRange(Hostel_Rooms."Hostel Code", ACAStudentsHostelRooms."Hostel No");
                    Hostel_Rooms.SetRange(Hostel_Rooms."Room Code", ACAStudentsHostelRooms."Room No");
        ...
        if not StudentCharges.Find('-') then begin //3
            ...
            if not StudentCharges.Find('-') then begin //4
                ...
                if CReg.Find('-') then begin //5
                    ...
                    StudentCharges.Description := 'Accommodation Fees';
                    StudentCharges.Amount := ACAStudentsHostelRooms.Charges;
                    StudentCharges.Date := Today;
                    StudentCharges.Code := charges1.Code;
