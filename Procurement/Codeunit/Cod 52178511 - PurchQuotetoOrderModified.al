codeunit 52178511 "Purch.-Quote to Order Modified"
{
        ...
        if PurchQuoteLine.FindSet() then
            repeat
                ...
                if not IsHandled then begin
                    ...
                    PurchOrderLine."Description 3" := PurchQuoteLine."Description 3";
                    PurchOrderLine.Validate("Description 2", PurchQuoteLine."Description 2");
                    PurchOrderLine.Validate("Description 3", PurchQuoteLine."Description 3");
