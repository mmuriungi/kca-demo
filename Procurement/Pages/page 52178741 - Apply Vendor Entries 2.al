    ...
    begin
        IF CalcType = CalcType::Direct THEN BEGIN
            IF ApplyingVendLedgEntry."Entry No." <> 0 THEN BEGIN
                ...
                PostApplication.SetParameters(NewApplyUnapplyParameters);
                ...
                IF PreviewMode THEN
                    VendEntryApplyPostedEntries.PreviewApply(VendorLedgerEntry, NewApplyUnapplyParameters)
                ELSE
                    VendEntryApplyPostedEntries.Apply(VendLedgEntry, ApplyUnapplyParameters);
