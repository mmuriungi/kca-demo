page 52178555 "Proc-Two Stage.Tender Header"
{
    ...
    PromotedActionCategories = 'Open,Process, Report,Evaluation Matrix, Tier Tendering,Bid,Award, Attachments';
    layout
    {
        area(content)
        {
    ...
    begin
        ...
        if Purchasespaybles.Find('-') then begin
            ...
            rec."No." := Purchasespaybles."Institution Code" + '/' + Purchasespaybles.Prefix + '/' + format(Month) + '/' + Newrefcode + '/' + Purchasespaybles.FY;
