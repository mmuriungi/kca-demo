page 56264 "KUCCPS Bulk SMS"
{
    ...
    var
        ...
        Customers: Record "KUCCPS Imports";
    ...
    begin
        ...
        Customers.Reset();
        Customers.SetRange("Phone", '<>');
        if Customers.FindSet() then begin
            repeat
                PhoneList.Add(Customers."Phone");
