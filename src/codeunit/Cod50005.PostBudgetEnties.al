codeunit 50005 "Post Budget Enties"
{
    ...
    //[Scope('Internal')]
    procedure CheckBudgetAvailability(GLAccount: Code[20]; Dates: Date; GlobalDim1Code: Code[20]; GlobalDim2Code: Code[20]; Amounts: Decimal; Descriptions: Text; DocumentType: Code[20]; DocumentNo: Code[20]; DocumentDescription: Text[250]; Payee: text[250])
    begin
    ...
    //[Scope('Internal')]
    procedure ExpenseBudget(GLAccount: Code[20]; Dates: Date; GlobalDim1Code: Code[20]; GlobalDim2Code: Code[20]; Amounts: Decimal; Descriptions: Text; UserID: Code[20]; LastDateModified: Date; DocumentType: Code[20]; DocumentNo: Code[20]; DocumentDescription: Text[250]; payee: code[250])
    begin
        ...
        IF NOT (FINBudgetEntries.FIND('-')) THEN BEGIN
            ...
            CheckBudgetAvailability(GLAccount, Dates, GlobalDim1Code, GlobalDim2Code, Amounts, Descriptions, DocumentType, DocumentNo, DocumentDescription, payee);
