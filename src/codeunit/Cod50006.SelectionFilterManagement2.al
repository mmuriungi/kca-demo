codeunit 50006 SelectionFilterManagement2
{
    ...
    procedure GetSelectionFilterForRFQ(var PurchRFQ: Record "PROC-Purchase Quote Header"): Text
    var
        RecRef: RecordRef;
    begin
        RecRef.GetTable(PurchRFQ);
        exit(GetSelectionFilter(RecRef, PurchRFQ.FieldNo("No.")));
    end;
