codeunit 50066 BankIntegration
{
    ...
    procedure GetPayEqtyTrans(inbankreference: Code[50]; indebitaccount: Code[20]; intransactionDate: Code[20]; inbillAmount: Code[20]; inpaymentMode: Code[20]; inphonenumber: Code[20]; incustomerRefNumber: Code[20]; indebitcustname: Text[150]) Status: Text[250]
    var
        Cust: Record Customer;
    ...
    begin
        ...
        if not Cust.Find('-') then begin
            ...
            if BankIntergration.Find('-') then begin
                ...
                BankIntergration.Insert;
                Status := 'OK' + '::' + 'SUCCESSFULL';
                //PostEqtyReceipt(BankIntergration);
    ...
    procedure GetPayKCBTrans(inbankreference: Code[50]; indebitaccount: Code[20]; intransactionDate: Code[20]; inbillAmount: Code[20]; inpaymentMode: Code[20]; inphonenumber: Code[20]; incustomerRefNumber: Code[20]; indebitcustname: Text[150]) Status: Text[250]
    var
        Cust: Record Customer;
        BankIntergration: Record "KCB Bank Intergration - Test";
        AmountsDecimal: Decimal;
