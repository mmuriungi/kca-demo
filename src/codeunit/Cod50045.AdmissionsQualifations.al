...
/// </summary>
codeunit 50045 "Admissions Qualifations"
{
    ...
    var
        ...
        ProgEntry: Record "ACA-Programme Entry Subjects";
        RequiredCount: Integer;
        PassCount: Integer;
        AppRec: Record "ACA-Applic. Form Header";
    begin
        Qualify := FALSE;
    ...
    var
        ...
        PassCount: Integer;
        AppRec: Record "ACA-Applic. Form Header";
        AppSubjects: Record "ACA-Applic. Form Academic";
    begin
        Qualify := FALSE;
        IF Prog.GET(Programme) THEN BEGIN
            ProgEntry.RESET;
