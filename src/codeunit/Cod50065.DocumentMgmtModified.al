codeunit 50065 "Document Mgmt Modified"
{
    ...
    var
        DocumentAttachment: Record "Document Attachment Modified";
    begin
    ...
    local procedure SetDocumentAttachmentFiltersForRecRef(var DocumentAttachment: Record "Document Attachment Modified"; RecRef: RecordRef)
    var
        FieldRef: FieldRef;
        RecNo: Code[20];
    ...
    procedure IsDuplicateFile(TableID: Integer; DocumentNo: Code[50]; RecDocType: Option Quote,"Order",Invoice,"Credit Memo","Blanket Order","Return Order"; RecLineNo: Integer; FileName: Text; FileExtension: Text): Boolean
    var
        DocumentAttachment: Record "Document Attachment Modified";
    begin
    ...
    var
        FromDocumentAttachment: Record "Document Attachment Modified";
        ToDocumentAttachment: Record "Document Attachment Modified";
    ...
    var
        FromDocumentAttachmentLines: Record "Document Attachment Modified";
        ToDocumentAttachmentLines: Record "Document Attachment Modified";
        FromFieldRef: FieldRef;
        ToFieldRef: FieldRef;
        FromDocumentType: Option Quote,"Order",Invoice,"Credit Memo","Blanket Order","Return Order";
        FromNo: Code[20];
    ...
    var
        DocumentAttachmentFound: Record "Document Attachment Modified";
        DocumentAttachmentToCreate: Record "Document Attachment Modified";
    ...
    begin
        ...
        if ShowAction then
            Notification.AddAction(ShowAttachmentsTxt, Codeunit::"Document Mgmt Modified", 'ShowDocumentAttachments');
    ...
    [IntegrationEvent(false, false)]
    local procedure OnCopyAttachmentsForPostedDocsOnBeforeToDocumentAttachmentInsert(var FromDocumentAttachment: Record "Document Attachment Modified"; var ToDocumentAttachment: Record "Document Attachment Modified")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnCopyAttachmentsForPostedDocsOnAfterToDocumentAttachmentInsert(var FromDocumentAttachment: Record "Document Attachment Modified"; var ToDocumentAttachment: Record "Document Attachment Modified")
    begin
    end;
}
