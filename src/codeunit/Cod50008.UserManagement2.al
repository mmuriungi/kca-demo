codeunit 50008 "User Management 2"
{
    ...
    local procedure ValidateLicenseTypeOnAfterModifyUser(var Rec: Record user; var xRec: Record 2000000120; RunTrigger: Boolean)
    begin
