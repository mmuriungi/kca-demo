codeunit 50048 "Claims Handler"
{
    ...
    procedure CreatePurchaseHeaderApproved(VendorNo: Code[20]; GlobalDim1: Code[20]; GlobalDim2: Code[20]; GlobalDim3: Code[20]; Date: Date; Description: Text[100]; ClaimNo: Code[20]; ClaimType: Enum "Claim Type"; BatchNo: Code[20]): Record "Purchase Header"
    var
        PurchSetup: Record "Purchases & Payables Setup";
        NoSeriesMgt: Codeunit NoSeriesManagement;
    ...
    procedure CreatePurchaseLineApproved(PurchHeader: Record "Purchase Header"; No: Code[20]; AccountTYpe: Enum "Purchase Line Type"; Quantity: Decimal; UnitCost: Decimal)
    var
        PurchLine: Record "Purchase Line";
        LineNo: Integer;
    begin
