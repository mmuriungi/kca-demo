...
Page 77717 "Process Graduation Params"
{
        ...
        area(creation)
        {
            action(ProcessGraduation)
            {
                ...
                var
                    ...
                    ACAGradfuationGroups: Record "ACA-Graduation Groups";
                    ClassCourseRegistration: Record "ACA-Course Registration";
                    CourseRegistration666: Record "ACA-Course Registration";
                    ...
                    StudUnitsForExclude: Record "ACA-Student Units";
                begin
                    ...
                    if ProgList.Find('-') then begin
                        ...
                        begin
                            ...
                            ClassStudentUnits.SetFilter(Status, '%1|%2', ClassStudentUnits.Status::Current, ClassStudentUnits.Status::Registration);
                                ...
                                begin
                                    ...
                                    if ACAProgrammeYearsofStudy.Find('-') then begin
                                        ...
                                        begin
                                            ...
                                            CourseRegistration666.SetRange(Programmes, ClassClassificationStudents.Programme);
                                    ...
                                    if ClassClassificationCourseReg.Find('-') then begin
                                        ...
                                        begin
                                            ...
                                            else if ((ClassClassificationCourseReg."Exam Missing" = true) and (ClassClassificationCourseReg."CATS Missing" = false)) then
                                                ExistsOption := Existsoption::"Exam Only"
                                            else if ((ClassClassificationCourseReg."Exam Missing" = false) and (ClassClassificationCourseReg."CATS Missing" = true)) then
                                  ...
                                  "Total Units", "Classified Total Marks", "Total Classified C. Count", "Classified W. Total", "Attained Stage Units");
                                    ...
                                    if ((ClassClassificationStudents."Exam Missing") and (ClassClassificationStudents."CATS Missing")) then
                                        ExistsOption := Existsoption::"None Exists"
                                    else if ((ClassClassificationStudents."Exam Missing" = true) and (ClassClassificationStudents."CATS Missing" = false)) then
                                        ExistsOption := Existsoption::"Exam Only"
                                    else if ((ClassClassificationStudents."Exam Missing" = false) and (ClassClassificationStudents."CATS Missing" = true)) then
                                        ExistsOption := Existsoption::"CAT Only"
    ...
    var
        ...
        ProgList: Record "ACA-Programme";
        YosStages: Text[150];
        ACAExamProcActiveUsers: Record "User Setup";
        ACAExamProcActiveUsers2: Record "User Setup";
        Aca2ndSuppExamsResults: Record "Aca-Special Exams Results";
        ProgForFilters: Record "ACA-Programme";
        AcaAcademicYear_Buffer: Record "Aca-AcademicYear_Buffer";
        AcaAcademicYear_Buffer2: Record "Aca-AcademicYear_Buffer";
        CountedLoops: Integer;
        AcademicYearArray: array[100] of Text[20];
        Arrayfound: Boolean;
        ACAProgrammeYearsofStudy: Record "ACA-Programme Years of Study";
    ...
    local procedure GetClassification(ProgCode: Code[20]; AverageScore: Decimal; HasIrregularity: Boolean; MarksStatus: Option " ","Both Exists","CAT Only","Exam Only","None Exists"; ACAClassificationStudents: Record "ACA-Classification Students") Classification: Code[100]
    var
        ...
        ACAClassGradLubrics: Record "ACA-Class/Grad. Rubrics";
    begin
    ...
    var
        ACAGraduationGroups: Record "ACA-Graduation Groups";
    begin
        Clear(GradGroup);
    ...
    begin
        ...
        ACAProgCatTranscriptComm.SetRange("Exam Category", Category);
    ...
    local procedure GetClassification2(ProgCode: Code[20]; AverageScore: Decimal; HasIrregularity: Boolean; MarksStatus: Option " ","Both Exists","CAT Only","Exam Only","None Exists"; ACAClassificationStudents: Record "ACA-Classification Students") Classification: Code[100]
    var
        ACAClassGradRubrics: Record "ACA-Class/Grad. Rubrics";
        ACAGradingSystemSetup: Record "ACA-Exam Gradding Setup";
        Programz1: Record "Aca-Programme";
    ...
    local procedure GetSuppMaxScore(SuppDets: Record "Aca-Special Exams Details"; Categoryz: Code[20]; Scorezs: Decimal) SuppScoreNormalized: Decimal
    var
    ...
    local procedure GetSupp2MaxScore(SuppDets: Record "Aca-2nd Supp. Exams Details"; Categoryz: Code[20]; Scorezs: Decimal) SuppScoreNormalized: Decimal
    var
        ACAExamCategory: Record "Aca-Exam Category";
    begin
        SuppScoreNormalized := Scorezs;
    ...
    var
        AcaProgrammes_Buffer: Record "Aca-Programmes_Buffer";
        AcaProgrammes_Buffer2: Record "Aca-Programmes_Buffer";
    begin
        if StudNos <> '' then begin
            ...
            if ACACourseRegistration.Find('-') then begin
                ...
                begin
                    ...
                    AcaProgrammes_Buffer2."Programme Code" := ACACourseRegistration.Programmes;
