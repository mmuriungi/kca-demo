...
page 51157 "Deans Committee"
{
    ...
    layout
    {
        area(content)
        {
            ...
            group("Registar Recommendation")
            {
                field("Registar Comments"; Rec."Registar Comments")
                {
                    ApplicationArea = All;
                }
            }
        ...
        area(processing)
        {
            ...
            action(cancellsApproval)
            {
                ...
                begin
                    ...
                    IF AppSetup.GET() THEN
                        IF CONFIRM('Reject This Application?', TRUE) = FALSE THEN EXIT;
                    ...
                    IF Rec."Rejection Reason" = '' THEN
                        ERROR('Provide the Rejection Reason First!');
                    Rec.Status := Rec.Status::"Admission Board Rejected";
                end;
            }
        }
