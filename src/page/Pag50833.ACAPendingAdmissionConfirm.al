...
/// </summary>
page 50833 "ACA-Pending Admission Confirm."
{
        ...
        area(navigation)
        {
            group(Documents)
            {
                ...
                action("Medical Data")
                {
                    Image = ViewDetails;
                    Promoted = true;
                    RunObject = Page "ACA-Admission Form Medical";
                    RunPageLink = "Admission No." = FIELD("Admission No.");
                    ApplicationArea = All;
                }
                action("Medical Info. 2")
                {
                    ...
                    RunObject = Page "ACA-Admission Family Medical";
                    RunPageLink = "Admission No." = FIELD("Admission No.");
                    ApplicationArea = All;
                }
                action("Insurance Details")
                {
                    ...
                    RunObject = Page "ACA-Admission Form Immun.";
                    RunPageLink = "Admission No." = FIELD("Admission No.");
                    ApplicationArea = All;
                }
            }
