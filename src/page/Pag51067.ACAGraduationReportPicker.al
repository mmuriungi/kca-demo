page 51067 "ACA-Graduation Report Picker"
{
    PageType = Card;
    SourceTable = "ACA-Graduation Report Picker";
        ...
        area(creation)
        {
            action(ClassificationList)
            {
                ...
                var
                    ...
                    FinalSenateClassificationz: Report "Final Senate Classification";
                begin
                    ...
                    IF ACAClassificationHeader.FIND('-') THEN BEGIN
                        REPORT.RUNMODAL(Report::"Final Senate Classification", FALSE, FALSE, ACAClassificationHeader);
                    END;
                end;
            }
            action("Graduation List")
            {
                ...
                var
                    ...
                    ACAClassificationHeader: Record "ACA-Classification Header";
                    FinalSenateClassificationz: Report "Final Senate Classification";
                    FinalGraduationList: Report "Final GraduationList";
                begin
                    Rec.TESTFIELD("Graduation Academic Year");
                    Rec.TESTFIELD(Programme);
                    ACACourseRegistration.RESET;
                    ...
                    IF ACAClassificationHeader.FIND('-') THEN BEGIN
                        ...
                        REPORT.RUNMODAL(Report::"Final GraduationList", FALSE, FALSE, ACAClassificationHeader);
                    END;
                end;
            }
        }
