page 50772 "ACA-Admissions List"
{
    CardPageID = "ACA-Admissions Card";
    PageType = List;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Res. District"; Rec."Res. District")
                {
                    ApplicationArea = All;
                }
                ...
                field("Declaration ID Number"; Rec."Declaration ID Number")
                {
                    ApplicationArea = All;
                }
