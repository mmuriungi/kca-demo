...
/// </summary>
page 51155 "HOD Applicants CARD"
{
    PageType = Document;
    ...
    layout
    {
        area(content)
        {
            ...
            group("COD Recommendation")
            {
                field("COD Comments"; Rec."COD Comments")
                {
                    ApplicationArea = All;
            ...
            action(sendApproval)
            {
                ...
                begin
                    ...
                    IF AppSetup.GET() THEN
                        ...
                        IF CONFIRM('Do You Want to Send This Application to The Dean', TRUE) = FALSE THEN EXIT;
