page 51721 "HMS-Laboratory Form Header"
{
    PageType = Document;
    ...
    layout
    {
        area(content)
        {
            ...
            group("Laboratory Test Package(s) Request")
            {
                Caption = 'Laboratory Test Package(s) Request';
                part(Page; "HMS-Laboratory Request Line")
                {
