page 51852 "HMS-Triage Rec. List"
{
        ...
        area(creation)
        {
            ...
            action(sendToAppointment)
            {
                ...
                begin
                    ...
                    Appointment.INSERT;
                    Rec."Patient Current Location" := Rec."Patient Current Location"::Appointment;
                    Rec."Appointment Status" := Rec."Appointment Status"::Appointment;
                    Rec."Triage Status" := Rec."Triage Status"::Cleared;
                    Rec.MODIFY;
            ...
            action(sendToObservation)
            {
                ...
                begin
                    ...
                    Rec."Registration Status" := Rec."Registration Status"::Cleared;
