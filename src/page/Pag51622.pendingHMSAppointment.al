...
page 51622 "pending HMS-Appointment "
{
    PageType = list;
            ...
            group("&Functions")
            {
                ...
                action("Notify the HOD")
                {
                    ...
                    begin
                        ...
                        Body := StrSubstNo('Your appointment have been scheduled to be on ', rec."Appointment Date", 'At', rec."Appointment Time", 'Kindly avail yourself on time', UserId);
