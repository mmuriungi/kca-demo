page 50081 "Supervision Tracking List"
{
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Lists;
    SourceTable = "Supervision Tracking";
    Caption = 'Supervision Tracking List';
    CardPageId = "Supervision Tracking Card";
    Editable = false;
    ...
    layout
    {
        area(Content)
        {
            repeater(Tracking)
            {
                ...
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the document number used for approval workflow';
                }
