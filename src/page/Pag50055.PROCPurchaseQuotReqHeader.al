page 50055 "PROC-Purchase Quot Req. Header"
{
    PageType = Card;
        ...
        area(processing)
        {
            ...
            action("Bid Analysis")
            {
                ...
                begin
                    ...
                    PurchaseHeader.SETRANGE(PurchaseHeader."Request for Quote No.", Rec."No.");
            ...
            action("&Print/Preview")
            {
                ...
                begin
                    ...
                    IF vends.FIND('-') THEN BEGIN
                        ...
                        REPORT.RUN(Report::"RFQ Report2", TRUE, FALSE, vends);
