/// <summary>
/// Page ACA-Applic. Form Department (ID 68481).
/// </summary>
page 50793 "ACA-Applic. Form Department"
{
    DeleteAllowed = false;
    PageType = Document;
            ...
            group("&Functions")
            {
                ...
                action("Mark as Approved")
                {
                    ...
                    begin
                        ...
                        Rec."HOD User ID" := USERID;
                        Rec."HOD Date" := TODAY;
                        Rec."HOD Time" := TIME;
                        Rec."Admissable Status" := 'Admissable';
                        Rec.MODIFY;
    ...
    var
        ...
        Text19021950: Label 'ACADEMIC BACK GROUND';
        Text19051046: Label 'Recommendations';

    /// <summary>
    /// GetCountry.
    /// </summary>
    /// <param name="CountryCode">VAR Code[20].</param>
    /// <returns>Return variable CountryName of type Text[200].</returns>
#pragma warning disable AL0523
    procedure GetCountry(var CountryCode: Code[20]) CountryName: Text[200]
