page 50053 "PROC-Purchase Quote List"
{
    ...
    begin
        ...
        exit(SelectionFilterManagement.GetSelectionFilterForPurchaseHeader(PurchHeader));
    end;

    procedure GetSelectionFilterRFQ(): Text
    var
        PurchRFQ: Record "PROC-Purchase Quote Header";
        SelectionFilterManagement: Codeunit SelectionFilterManagement2;
    begin
        CurrPage.SetSelectionFilter(PurchRFQ);
        exit(SelectionFilterManagement.GetSelectionFilterForRFQ(PurchRFQ));
    end;
