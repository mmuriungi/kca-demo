page 50045 "FIN-Travel Advance Req. UP"
{
    ...
    layout
    {
        area(content)
        {
            ...
            group(General)
            {
                ...
                {
                    ApplicationArea = all;
                    Editable = OverdueDateEditable;

                }
                field("Surrender Days"; Rec."Surrender Days")
                {
                    ApplicationArea = all;
                    Visible = false;
    ...
    begin
        ...
        if Usersetup."Can Extend Surrender Period" then
            OverdueDateEditable := true

        else
            OverdueDateEditable := false;
    ...
    var
        ...
        LastEntry: Integer;
        VBank: Record 287;
        extendSurrenderDateEditable: Boolean;
        ...
        IF FINImprestLines.FIND('-') THEN BEGIN
            ...
            BEGIN
                ...
                IF (FINImprestLines.Amount > 0) THEN BEGIN
                    ...
                    FINImprestLines.Amount, FINImprestLines."Account Name", USERID, TODAY, 'IMPREST', Rec."No." + FINImprestLines."Account No:", FINImprestLines.Purpose, Rec.Payee);
                END;
            END;
            UNTIL FINImprestLines.NEXT = 0;
