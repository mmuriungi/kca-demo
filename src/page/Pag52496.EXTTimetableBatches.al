...
/// </summary>
page 52496 "EXT-Timetable Batches"
{
    Caption = 'Timetable Batches';
    PageType = List;
    SourceTable = "EXT-Timetable Batches";
    ...
    actions
    {
        area(creation)
        {
            ...
            action(GenTT)
            {
                ...
                trigger OnAction()
                var
                    TTLecturers: Record "EXT-Lecturers";
                    TTProgrammes: Record "EXT-Programmes";
                    TTUnits: Record "EXT-Units";
            ...
            action(MasterRep1)
            {
                ...
                begin
                    ...
                    IF TTTimetableFInalCollector.FIND('-') THEN
                        REPORT.RUN(Report::"EXT-Master Timetable (Final)", TRUE, FALSE, TTTimetableFInalCollector);
                end;
            }
            action(MasterRep2)
            {
                ...
                begin
                    ...
                    TTTimetableFInalCollector.SETRANGE(Semester, Rec.Semester);
                    IF TTTimetableFInalCollector.FIND('-') THEN
                        REPORT.RUN(Report::"EXT-Master Timetable (Final) 2", TRUE, FALSE, TTTimetableFInalCollector);
                end;
            }
            action(DistribRep)
            {
                ...
                trigger OnAction()
                var
                    EXTUnits: Record "EXT-Units";
                begin
                    EXTUnits.RESET;
                    EXTUnits.SETRANGE(Semester, Rec.Semester);
                    IF EXTUnits.FIND('-') THEN
                        REPORT.RUN(Report::"EXT-Timetable Dist. Summary", TRUE, FALSE, EXTUnits);
                end;
            }
    ...
    var
        ...
        TTTimetableFInalCollector: Record "EXT-Timetable FInal Collector";
        EXTUnitSpecRooms: Record "EXT-Unit Spec. Rooms";

    local procedure GenerateEntriesSingles()
    var
        TTRooms: Record "TT-Rooms";
        TTDailyLessons: Record "EXT-Daily Periods";
        ACALecturersUnits: Record "ACA-Lecturers Units";
        TTTimetableCollectorA: Record "EXT-Timetable Collector";
        ...
        TTUnits: Record "EXT-Units";
        TTLessons: Record "EXT-Periods";
        TTDays: Record "EXT-Dates";
        progre: Dialog;
        counts: Integer;
        RecCount1: Text[120];
        RecCount2: Text[120];
        ...
        TTProgSpecCampuses: Record "EXT-Prog. Spec. Campuses";
        TTProgSpecDays: Record "EXT-Prog. Spec. Days";
        TTUnitSpecCampuses: Record "EXT-Unit Spec. Campuses";
        TTUnitSpecRooms: Record "EXT-Unit Spec. Rooms";
        TTLectSpecCampuses: Record "EXT-Lect. Spec. Campuses";
        TTLectSpecDays: Record "EXT-Lect. Spec. Days";
        TTLectSpecLessons: Record "EXT-Lect. Spec. Lessons";
    ...
    var
        ...
        TTTimetableCollectorA: Record "EXT-Timetable Collector";
        TTTimetableCollectorA1: Record "EXT-Timetable Collector";
        TTTimetableCollectorA2: Record "EXT-Timetable Collector";
        LectLoadBatchLines: Record "Lect Load Batch Lines";
        ACAProgramme: Record "ACA-Programme";
        ACAUnitsSubjects: Record "ACA-Units/Subjects";
    ...
    var
        ...
        TTUnitSpecCampuses: Record "EXT-Unit Spec. Campuses";
        TTUnitSpecRooms: Record "EXT-Unit Spec. Rooms";
        TTTimetableCollectorSingles: Record "EXT-Timetable Collector";
        TTProgrammes: Record "EXT-Programmes";
        TTUnits: Record "EXT-Units";
        TTLecturers: Record "EXT-Lecturers";
