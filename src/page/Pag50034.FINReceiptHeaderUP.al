page 50034 "FIN-Receipt Header UP"
{
    Caption = 'Receipt';
    DeleteAllowed = false;
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            group(general)
            {
                ...
                field("Account No"; Rec."On Behalf Of")
                {
                    Caption = 'Account No.';
                    //ApplicationArea = All;
                    Visible = false;
    ...
    begin
        ...
        IF BAmount < tAmount THEN BEGIN
            ...
            GenJnlLine.Description := Rec."On Behalf Of";
            ...
            IF ReceiptLine.FIND('-') THEN BEGIN
                REPEAT
                    ...
                    IF ReceiptLine."Pay Mode" <> ReceiptLine."Pay Mode"::Cheque THEN BEGIN
                        ...
                        GenJnlLine.Description := COPYSTR(Rec."On Behalf Of" + ':' + FORMAT(ReceiptLine."Pay Mode") +
