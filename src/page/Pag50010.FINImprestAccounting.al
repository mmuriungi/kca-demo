page 50010 "FIN-Imprest Accounting"
{
        ...
        area(processing)
        {
            ...
            action(Print)
            {
                ...
                begin
                    ...
                    REPORT.RUN(52178726, TRUE, TRUE, Rec);
                    Rec.RESET;
                end;
            }
        }
        ...
        IF FINImprestSurrLines.FIND('-') THEN BEGIN
            ...
            BEGIN
                ...
                IF (FINImprestSurrLines.Amount > 0) THEN BEGIN
                    ...
                    FINImprestSurrLines.Amount, FINImprestSurrLines."Account Name", USERID, TODAY, 'IMPREST', Rec."Imprest Issue Doc. No" + FINImprestSurrLines."Account No:", '', Rec."Account Name");
                END;
            END;
