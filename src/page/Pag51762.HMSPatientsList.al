    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Appointments Scheduled"; Rec."Appointments Scheduled")
                {
                    ApplicationArea = All;
                }
                field("Appointments Completed"; Rec."Appointments Completed")
                {
                    ApplicationArea = All;
                }
                field("Appointments Rescheduled"; Rec."Appointments Rescheduled")
                {
                    ApplicationArea = All;
                }
                field("Appointments Cancelled"; Rec."Appointments Cancelled")
                {
                    ApplicationArea = All;
                }
                ...
                field("Drug Reaction"; Rec."Drug Reaction")
                {
                    ApplicationArea = All;
                }
                ...
                field("Immunization Number"; Rec."Immunization Number")
                {
                    ApplicationArea = All;
                }
                ...
                field("Triage Status"; Rec."Triage Status")
                {
                    ApplicationArea = All;
                }
                ...
                field("Doctor Visit Status"; Rec."Doctor Visit Status")
                {
                    ApplicationArea = All;
                }
                field("Laboratory Status"; Rec."Laboratory Status")
                {
                    ApplicationArea = All;
                }
                field("Radiology Status"; Rec."Radiology Status")
                {
                    ApplicationArea = All;
                }
                field("Pharmacy Status"; Rec."Pharmacy Status")
                {
                    ApplicationArea = All;
                }
                field("Hospital Billing Status"; Rec."Hospital Billing Status")
                {
                    ApplicationArea = All;
                }
            }
