/// <summary>
/// Page ACA-Admn Letters Direct (ID 68515).
/// </summary>
page 51897 "ACA-Admn Letters Direct"
{
    PageType = List;
    SourceTable = "ACA-Adm. Form Header";
    SourceTableView = WHERE("Admission Type" = CONST(''));
                ...
                begin
                    ...
                    IF Admissions.FIND('-') THEN BEGIN
                        REPEAT
                            ...
                            IF Admissions."Admission Type" = 'SSP' THEN BEGIN
