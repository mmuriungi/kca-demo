page 52404 "TT-Timetable Batches"
{
    Caption = 'Timetable Batches';
    PageType = List;
    SourceTable = "TT-Timetable Batches";
            ...
            action(MasterRep1)
            {
                ...
                begin
                    ...
                    IF TTTimetableFInalCollector.FIND('-') THEN
                        REPORT.RUN(Report::"TT-Master Timetable (Final)", TRUE, FALSE, TTTimetableFInalCollector);
                end;
            }
            action(MasterRep2)
            {
            ...
            action(DistribRep)
            {
                ...
                begin
                    ...
                    IF TTUnits.FIND('-') THEN
                        REPORT.RUN(Report::"TT-Timetable Dist. Summary", TRUE, FALSE, TTUnits);
                end;
            }
    ...
    var
        ...
        TTUnitSpecRooms111: Record "TT-Unit Spec. Rooms";
    ...
    var
        ...
        TTProgSpecCampuses: Record "TT-Prog. Spec. Campuses";
        TTProgSpecDays: Record "TT-Prog. Spec. Days";
        TTProgSpecRooms: Record "TT-Prog. Spec. Rooms";
        TTUnitSpecCampuses: Record "TT-Unit Spec. Campuses";
        TTUnitSpecRooms: Record "TT-Unit Spec. Rooms";
        TTLectSpecCampuses: Record "TT-Lect. Spec. Campuses";
        TTLectSpecDays: Record "TT-Lect. Spec. Days";
        TTLectSpecLessons: Record "TT-Lect. Spec. Lessons";
    begin
    ...
    var
        ...
        TTDailyLessons: Record "TT-Daily Lessons";
        ACALecturersUnits: Record "ACA-Lecturers Units";
        TTTimetableCollectorDoubles: Record "TT-Timetable Collector Doubles";
        LectLoadBatchLines: Record "Lect Load Batch Lines";
        ACAProgramme: Record "ACA-Programme";
        ACAUnitsSubjects: Record "ACA-Units/Subjects";
        TTUnits: Record "TT-Units";
        TTLessons: Record "TT-Lessons";
        TTDays: Record "TT-Days";
        TTLessons1: Record "TT-Lessons";
        TTLessons2: Record "TT-Lessons";
        TTLessons3: Record "TT-Lessons";
        progre: Dialog;
        counts: Integer;
        RecCount1: Text[120];
        RecCount2: Text[120];
    ...
    var
        ...
        TTDailyLessons: Record "TT-Daily Lessons";
        ACALecturersUnits: Record "ACA-Lecturers Units";
        TTTimetableCollectorDoubles: Record "TT-Timetable Collector Tripple";
        LectLoadBatchLines: Record "Lect Load Batch Lines";
        ACAProgramme: Record "ACA-Programme";
        ACAUnitsSubjects: Record "ACA-Units/Subjects";
        TTUnits: Record "TT-Units";
    ...
    var
        ...
        TTDailyLessons: Record "TT-Daily Lessons";
        ACALecturersUnits: Record "ACA-Lecturers Units";
        TTTimetableCollectorTripple: Record "TT-Timetable Collector Tripple";
        LectLoadBatchLines: Record "Lect Load Batch Lines";
        ACAProgramme: Record "ACA-Programme";
        ACAUnitsSubjects: Record "ACA-Units/Subjects";
        TTUnits: Record "TT-Units";
    ...
    var
        ...
        TTWeightLessonCategories: Record "TT-Weight Lesson Categories";
        TTTimetableCollectorA: Record "TT-Timetable Collector Singles";
        TTTimetableCollectorA1: Record "TT-Timetable Collector Singles";
        TTTimetableCollectorA2: Record "TT-Timetable Collector Singles";
        TTTimetableCollectorA3: Record "TT-Timetable Collector Singles";
        TTTimetableCollectorDoubles: Record "TT-Timetable Collector Doubles";
        TTTimetableCollectorDoubles1: Record "TT-Timetable Collector Doubles";
        TTTimetableCollectorDoubles2: Record "TT-Timetable Collector Doubles";
        TTTimetableCollectorTripple: Record "TT-Timetable Collector Tripple";
        TTTimetableCollectorTripple1: Record "TT-Timetable Collector Tripple";
        TTTimetableCollectorTripple2: Record "TT-Timetable Collector Tripple";
        Loops: Integer;
        progre: Dialog;
        counts: Integer;
        RecCount1: Text[120];
    ...
    var
        ...
        TTUnitSpecCampuses: Record "TT-Unit Spec. Campuses";
        TTUnitSpecRooms: Record "TT-Unit Spec. Rooms";
        TTTimetableCollectorSingles: Record "TT-Timetable Collector Singles";
        TTTimetableCollectorDoubles: Record "TT-Timetable Collector Doubles";
        TTTimetableCollectorTripple: Record "TT-Timetable Collector Tripple";
        TTProgrammes: Record "TT-Programmes";
        TTUnits: Record "TT-Units";
