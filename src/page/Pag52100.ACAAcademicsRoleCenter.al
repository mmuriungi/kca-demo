...
/// </summary>
page 52100 "ACA-Academics Role Center"
{
    Caption = 'Role Center';
    PageType = RoleCenter;
    ...
    actions
    {
        ...
        area(sections)
        {
            ...
            group("KUCCPS Admission")
            {
                ...
                {
                    Caption = 'Reported Students - KUCCPS';
        ...
        area(reporting)
        {
            group(Periodic)
            {
                ...
                group("Admissions Reports")
                {
                    action("Application Summary2")
                    {
                        Caption = 'Application Summary';
                        Image = Report;
                        RunObject = Report "Applications Summary";
                        ApplicationArea = All;
                    }
                    ...
                    action("Report")
                    {
                        Caption = 'Reported Students Summary Report';
                        Image = Report;
                        RunObject = Report "ACA-Reported Students";
                        ApplicationArea = All;
                    }
                    action("Student Applications Report(Program)")
                    {

                        Image = Report;
                        RunObject = Report "Student Applications(Program)";
                        ApplicationArea = All;
                    }
