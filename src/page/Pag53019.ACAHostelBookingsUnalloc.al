page 53019 "ACA-Hostel Bookings (Unalloc.)"
{
    DeleteAllowed = true;
    PageType = List;
            ...
            REPEAT
                ...
                IF NOT StudentCharges.FIND('-') THEN BEGIN
                    ...
                    IF coReg.FIND('-') THEN BEGIN
                        ...
                        // ELSE
                        StudentCharges.Amount := charges1.Amount;
    ...
    begin
       ...
       END;*/
        ...
        //     //tetrive the email address
        //     emailAddress := rec.EMAIL;
        //     //set html 
        //     isHtml := false;
        //     sent := mail.Send(subject, Body, emailAddress, isHtml);
        //     //if the email was send successfuly 
        //     if sent then
        //         Message('email send successfully ', EmailAddress);

        //     else


        //        error('failed to sent email to;')
