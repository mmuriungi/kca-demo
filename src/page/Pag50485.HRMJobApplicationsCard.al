page 50485 "HRM-Job Applications Card"
{
    PageType = Card;
    ...
    actions
    {
        area(navigation)
        {
            group("&Functions")
            {
                ...
                action("Membership to proff Bodies")
                {
                    ApplicationArea = all;
                    ...
                    RunObject = Page "Publications Recruitment list";
