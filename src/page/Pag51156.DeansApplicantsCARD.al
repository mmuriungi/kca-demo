...
/// </summary>
page 51156 "Deans Applicants CARD"
{
    PageType = Document;
        ...
        area(processing)
        {
            ...
            action(sendApproval)
            {
                ...
                begin
                    ...
                    Rec.TESTFIELD("Dean Recommendations");
                    ...
                    IF AppSetup.GET() THEN
                        ...
                        IF CONFIRM('Do You Want to Send This Application to The Deans Registrar', TRUE) = FALSE THEN EXIT;
