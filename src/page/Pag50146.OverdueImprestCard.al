page 50146 "Overdue Imprest Card"
{
    Caption = 'Fin-overdue Imprest';
    PageType = Card;
            ...
            group("&Functions")
            {
                ...
                action("Transfer To Payroll")
                {
                    ...
                    begin
                        ...
                        // Rec.SetFilter("Posted To Payroll", '%1', false);
                        // Rec.SetFilter("Expected Date of Surrender", '<%1', TODAY);
                        Clear(TotRecs);
                        payHeader.reset;
                        payHeader.SetRange("Posted To Payroll", false);
                        payHeader.SetFilter("Expected Date of Surrender", '<=1%', TODAY);
                        TotRecs := payHeader.Count;
                        if not Confirm('This process will Transfer to payroll ' + Format(TotRecs) + ' imprest.\Do you wish to proceed?') then
                            exit;



                        FinOperation.RecoverFromPayroll();
                    end;
    ...
    var
        ...
        IntC: Integer;
        IntCount: Integer;
        FinOperation: Codeunit "Finance Operations";
        ...
        IF payrollperiod.FIND('-') THEN begin
            ...
            if not PrlEmployeeTransactions.FindFirst() then begin
                Repeat
                    ...
                    PrlEmployeeTransactions."Transaction Code" := 'D-0001';
                    PrlEmployeeTransactions.Amount := Rec."Total Net Amount";
