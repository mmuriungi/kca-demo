...
/// </summary>
page 56050 "ACA-Std Fin. Role Center"
{
    Caption = 'Role Center';
    PageType = RoleCenter;
    ...
    actions
    {
        area(processing)
        {
            action("Students With Balances")
            {
                ...
                RunObject = Report "ACA-Student Balances Per Prog.";
                ApplicationArea = All;
            }
        ...
        area(sections)
        {
            ...
            group("Reversals and Charge Additions")
            {
                action("Reversals")
                {
                    Caption = 'Reversals';
                    RunObject = Page "Std-Charges Reversal List";
                    ApplicationArea = All;
                }
