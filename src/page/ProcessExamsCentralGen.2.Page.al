...
"Prog. Total Count");
    ...
    var
        ...
        Aca2ndSuppExamsResults: Record "Aca-2nd Supp. Exams Results";
        AcaAcademicYear_Buffer: Record "ACA-Academic Year";
        AcaAcademicYear_Buffer2: Record "ACA-Academic Year";
    ...
    local procedure GetRubric(ACAProgramme: Record "ACA-Programme"; CoursesRegz: Record "ACA-Exam. Course Registration"; Semesz: Code[10]) StatusRemarks: Text[150]
    var
    ...
    local procedure GetRubricPassStatus(RubricCode: Code[50]; AcademicYears: Code[250]; Progyz: Record "ACA-Programme") PassStatus: Boolean
    var
        ACAResultsStatus: Record "ACA-Results Status";
    begin
   ...
   "Tota Electives Passed");
    ...
    var
        ...
        Aca2ndSuppExamsDetails4: Record "Aca-2nd Supp. Exams Details";
        AcaSpecialExamsDetails4: Record "Aca-Special Exams Details";
        ACAResultsStatusSupp: Record "ACA-Results Status";
    begin
    ...
    */
    ...
    ObjUnits	Record	ACA-Student Units	
    */
    local procedure GetRubricSupp2(ACAProgramme: Record "ACA-Programme"; CoursesRegz: Record "ACA-2ndSuppExam. Co. Reg.") StatusRemarks: Text[150]
    var
        Customer: Record "ACA-Course Registration";
        LubricIdentified: Boolean;
        ACAResultsStatus: Record "ACA-2ndSupp. Results Status";
