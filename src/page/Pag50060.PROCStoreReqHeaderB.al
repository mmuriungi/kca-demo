page 50060 "PROC-Store Req. Header (B)"
{
    PageType = Card;
            ...
            group("&Functions")
            {
                ...
                action("Post Store Requisition")
                {
                    ...
                    begin
                        ...
                        IF (ReqLine."Qty in store" < ReqLine."Quantity To Issue")
                       THEN
                            ERROR('Quantity in store is less than quantity requested %1', ReqLine."Qty in store");




                        IF (ReqLine."Qty in store" < ReqLine."Quantity Requested")
                       THEN
                            ERROR('Quantity in store is less than quantity requested %1', ReqLine."Qty in store");
                     ...
                     ReqLine.SETFILTER*/
                        ...
                        IF ReqLine.FIND('-') THEN BEGIN
                            ...
                            if Item.Find('-') then begin
                                genProdPost := Item."Gen. Prod. Posting Group";
                            end;
                            ...
                            BEGIN
                                ...
                                GenJnline."Gen. Prod. Posting Group" := genProdPost;
                                ...
                                GenJnline."Unit Amount" := ReqLine."Quantity To Issue" * ReqLine."Unit Cost";
                                GenJnline.Amount := ReqLine."Quantity To Issue" * ReqLine."Unit Cost";
                                GenJnline."Amount (ACY)" := ReqLine."Quantity To Issue" * ReqLine."Unit Cost";
