...
/// </summary>
page 53607 "ELECT-Elections Header List"
{
            ...
            group(Activities)
            {
                ...
                action(RankCandidates)
                {
                    ...
                    begin
                        ...
                        ELECTPositions.SETRANGE("Election Code", Rec."Election Code");
                        IF ELECTPositions.FIND('-') THEN BEGIN
                            REPORT.RUN(Report::"ELECT-Populate Ranking", FALSE, FALSE, ELECTPositions);
                            REPORT.RUN(Report::"ELECT-Get Candidate Ranks", FALSE, FALSE, ELECTPositions);
                        END;
                    end;
                }
            }
            ...
            group(Reports)
            {
                ...
                action(VoterRegister)
                {
                    ...
                    begin
                        ...
                        IF ELECTPollingCenters.FIND('-') THEN BEGIN
                            REPORT.RUN(Report::"ELECT-Voter Register", TRUE, FALSE, ELECTPollingCenters);
                        END;
                    end;
                }
                action(Agents)
                {
                    ...
                    begin
                        ...
                        IF ELECTElectralDistricts.FIND('-') THEN BEGIN
                            REPORT.RUN(Report::"ELECT-Poll Agents", TRUE, FALSE, ELECTElectralDistricts);
                        END;
                    end;
                }
                action(BallotPapers)
                {
                    ...
                    begin
                        ELECTPositions.RESET;
                        ELECTPositions.SETRANGE("Election Code", Rec."Election Code");
                        IF ELECTPositions.FIND('-') THEN REPORT.RUN(Report::"ELECT-Ballot Papers", TRUE, FALSE);
                    end;
                }
                action(ResultsSummary)
                {
                    ...
                    begin
                        ELECTPositions.RESET;
                        ELECTPositions.SETRANGE("Election Code", Rec."Election Code");
                        IF ELECTPositions.FIND('-') THEN REPORT.RUN(Report::"ELECT-Results Summary", TRUE, FALSE);
                    end;
                }
                action(Winners)
                {
                    ...
                    begin
                        ELECTPositions.RESET;
                        ELECTPositions.SETRANGE("Election Code", Rec."Election Code");
                        IF ELECTPositions.FIND('-') THEN REPORT.RUN(Report::"ELECT-Election Winners", TRUE, FALSE);
                    end;
                }
            }
        }
    ...
    var
        ELECTMyPositions: Record "ELECT-My Positions";
        ...
        ELECTCandidates: Record "ELECT-Candidates";

        ELECTElectralDistricts: Record "ELECT-Electoral Districts";
        ELECTPollingCenters: Record "ELECT-Polling Centers";
}
