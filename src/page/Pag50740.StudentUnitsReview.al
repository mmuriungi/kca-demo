page 50740 "Student Units Review"
{
    PageType = List;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Include in Graduation"; Rec."Include in Graduation")
                {
                    ApplicationArea = All;
                }
                ...
                field("Supp. Academic Year"; Rec."Supp. Academic Year")
                {
                    ApplicationArea = All;
                }
                ...
                field("Reg Option"; Rec."Reg Option")
                {
                    ApplicationArea = All;
                }
