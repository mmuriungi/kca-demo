page 51206 "ACA-Std Rooms Transfer"
{
    PageType = Card;
    SourceTable = "ACA-Students Hostel Rooms";
    SourceTableView = WHERE(Cleared = filter(true));
    ...
    layout
    {
        area(content)
        {
            ...
            group(CurrDetails2)
            {
                ...
                field("Transfer to Hostel No"; Rec."Transfer to Hostel No")
                {
                    ApplicationArea = All;
                }
                field("Transfer to Room No"; Rec."Transfer to Room No")
                {
                    ApplicationArea = All;
                }
                field("Transfer to Space No"; Rec."Transfer to Space No")
                {
                    ApplicationArea = All;
                }
            }
                    ...
                    IF rooms1.FIND('-') THEN BEGIN
                        ...
                        IF rooms2.FIND('-') THEN BEGIN
                            IF NOT (prog."Special Programme") THEN BEGIN
                                ...
                                END ELSE
                                    IF CourseReg."Settlement Type" = 'PSSP' THEN BEGIN
    ...
    begin
        ...
        hostLedger.SETRANGE(hostLedger."Student No", Rec.Student);
        ...
        END ELSE
            ERROR('Allocation was done wrongly');
