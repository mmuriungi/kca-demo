page 50002 "FIN-Bank & Cash Trans. Req. UP"
{
    DeleteAllowed = false;
    PageType = Card;
                ...
                action(sendApproval)
                {
                    ...
                    /*  trigger OnAction()
                     var
                         ...
                         tableNo: Integer;
                         "Responsibility Centre": Integer;
                     begin
                         Rec.TESTFIELD("Request Amt LCY");
                         ...
                         //IF ApprovalMgt.SendApproval(tableNo, Rec.No, DocType, State, Rec."Sending Responsibility Center", 0) THEN;
                         //  IF ApprovalMgt.SendLeaveApprovalRequest(Rec) THEN;
                     end; */

                    trigger OnAction()
                    var
                        AppMgnt: Codeunit "Init Code";
                    begin
                        AppMgnt.OnSendInterBankforApproval(Rec);
