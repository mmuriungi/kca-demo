page 53003 "ACA-Stud. Hostel Rooms"
{
    PageType = ListPart;
        ...
        area(processing)
        {
            ...
            action("Print Invoice")
            {
                ...
                begin
                    ...
                    IF allocations.FIND('-') THEN
                        REPORT.RUN(Report::"Hostel Invoice", TRUE, FALSE, allocations);
                    /* END ELSE BEGIN
            ...
            action(trans)
            {
                ...
                begin
                    ...
                    IF hostStus.FIND('-') THEN BEGIN
                        PAGE.RUN(Page::"ACA-Std Rooms Transfer", hostStus);
                    END;
                end;
            }
            action(Switch_Rooms)
            {
                ...
                begin
                    ...
                    IF hostStus.FIND('-') THEN BEGIN
                        PAGE.RUN(Page::"ACA-Std Rooms - Swap/Switch", hostStus);
                    END;
                end;
            }
            action("Clear Room")
            ...
            ELSE
                ...
                ELSE
                    IF settle_m = settle_m::PSSP THEN
                        ...
                        billAmount := Rec.Charges;
            IF billAmount = 0 THEN billAmount := Rec.Charges;
