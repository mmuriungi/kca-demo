page 52456 "ACA-Exam Results Raw Buffer"
{
    PageType = List;
            ...
            group(Post)
            {
                ...
                action(Post_Res)
                {
                    ...
                    begin
                        ...
                        progre.CLOSE;
                        PAGE.RUN(Page::"Process Exams Central");
    ...
    var
        ...
        examrawbuffer: Record "ACA-Exam Results Raw Buffer";
        resBuffer2: Record "ACA-Exam Results Buffer 2";
        unit_1: Code[10];
        unit_2: Code[10];
        unit_3: Code[10];
        unit_4: Code[10];
    ...
    var
        ...
        custBuff: Record "ACA-Exam Results Raw Buffer";
        replace: Text[100];
