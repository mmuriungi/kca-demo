page 50127 "Imprest List Finance"
{
    ApplicationArea = All;
    Caption = 'Imprest List Finance';
    PageType = List;
    SourceTable = "FIN-Imprest Header";
    UsageCategory = Lists;
    CardPageID = "FIN-Travel Advance Req. UP";
    // Editable = false;
    SourceTableView = WHERE(Status = FILTER(<> Posted), "Pay Using Pv" = filter(false));
    ...
    layout
    {
        area(content)
        {
            ...
            {
                //field(Processpv; Rec.Processpv) { ApplicationArea = all; }
                field("No."; Rec."No.")
                {
                    ApplicationArea = All;
                }
    ...
    var
        ...
        FinOpertaion: Codeunit "Finance Operations";
                ...
                IF FINBudgetEntries.FIND('-') THEN BEGIN
                    IF FINBudgetEntries.CALCSUMS(Amount) THEN BEGIN
                        IF FINBudgetEntries.Amount > 0 THEN BEGIN
                            ...
                            FINImprestLines.Amount, FINImprestLines."Account Name", 'IMPREST', Rec."No." + FINImprestLines."Account No:", Rec.Purpose, Rec.Payee);
                        END ELSE
        ...
        IF FINImprestLines.FIND('-') THEN BEGIN
            ...
            BEGIN
                ...
                IF (FINImprestLines.Amount > 0) THEN BEGIN
                    ...
                    FINImprestLines.Amount, FINImprestLines."Account Name", USERID, TODAY, 'IMPREST', Rec."No." + FINImprestLines."Account No:", Rec.Purpose, Rec.Payee);
                END;
            END;
            UNTIL FINImprestLines.NEXT = 0;
        END;
