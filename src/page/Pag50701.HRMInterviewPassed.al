page 50701 "HRM-Interview Passed"
{
    CardPageID = "HRM Successfull Candidate";
    PageType = List;
    PromotedActionCategories = 'New,Process,Report,Applicant,Functions,Print';
    SourceTableView = sorting("Interview Marks") order(Descending) WHERE("Interview Status" = FILTER(Passed));
