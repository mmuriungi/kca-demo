page 50147 "Imprest Transfer to Payroll"
{
    Caption = 'Imprest Transfer to Payroll';
    PageType = List;
    ...
    SourceTableView = WHERE(Posted = CONST(true), "Surrender Status" = const(" "), "Posted To Payroll" = filter(True));
