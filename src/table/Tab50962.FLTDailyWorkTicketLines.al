table 50962 "FLT-Daily Work Ticket Lines"
{
    ...
    fields
    {
        ...
        field(11; "End Milleage"; Decimal)
        {
            ...
            begin
                if "Start Milleage" > 0.0 then
                    "Kilometers Covered2" := "End Milleage" - "Start Milleage" else
                    "Kilometers Covered2" := 0.0;
                Modify();
            end;
        }
        ...
        {
            CalcFormula = Lookup("HRM-Employee C"."First Name" WHERE("No." = FIELD("Authorizing Officer No")));
            FieldClass = FlowField;
        }
        ...
        field(27; "Purpose of the Journey"; text[60])
        {
            DataClassification = ToBeClassified;
        }
        field(28; "Kilometers Covered2"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
