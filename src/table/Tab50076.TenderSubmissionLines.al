table 50076 "Tender Submission Lines"
{
    ...
    fields
    {
        ...
        field(50005; "Asset No."; Code[10])
        {
            TableRelation = "Fixed Asset"."No.";
        }
        field(50006; Specifications; Integer)
        {
            FieldClass = Normal;
        }
        field(50007; "Tender No."; code[50])
        {
        ...
        field(99000760; "Document Date"; date)
        {
            Caption = 'Routing Reference No.';
        }
        field(99000761; "RFQ No."; Code[20])
        {
            Caption = 'Routing Reference No.';
        }
    ...
    keys
    {
        ...
        key(Key10; "Document Type", "Buy-from Bidder No.")
        {
        }
