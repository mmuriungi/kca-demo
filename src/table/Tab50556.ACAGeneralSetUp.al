table 50556 "ACA-General Set-Up"
{
    ...
    fields
    {
        ...
        field(50068; "Receipt Buffer Nos"; code[20])
        {

            DataClassification = ToBeClassified;
            TableRelation = "No. Series";
        }
        field(50069; "Grants Account"; code[20])
        {
            TableRelation = "G/L Account"."No.";

        }
        field(50070; "Project Req No"; code[20])
        {
            TableRelation = "No. Series";

        }
        field(50071; "Grant Nos"; code[20])
        {
            TableRelation = "No. Series";

        }
        field(50072; "Exam Buffer Nos"; code[20])
        {
            TableRelation = "No. Series";

        }
        field(50073; "Fee Penalty Nos"; code[20])
        {
            TableRelation = "No. Series";

        }
        field(50074; "Std charge Reversal Nos"; code[20])
        {
            TableRelation = "No. Series";

        }
        field(50075; mouNos; code[20])
        {
            TableRelation = "No. Series";

        }
        field(50076; "Meeting Nos"; code[20])
        {
            TableRelation = "No. Series";

        }
        field(50077; "Charge Addition"; code[20])
        {
            TableRelation = "No. Series";
        ...
        field(50091; "Supervision Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
