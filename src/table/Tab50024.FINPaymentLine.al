table 50024 "FIN-Payment Line"
{
    ...
    fields
    {
        ...
        field(50022; "Vendor pv"; Code[20])
        {
            ...
            begin
                TaxLedgers.reset;
                TaxLedgers.SetRange("Vendor Pv No", Rec."Vendor pv");
                if TaxLedgers.FindFirst() then begin
                    TaxLedgers.CalcFields("Paid Amount");
                    Rec.Amount := TaxLedgers."Vat Withold";
                    Rec.Validate(Amount);
                    // Rec."Net Amount" := (TaxLedgers."Vat Withold" - TaxLedgers."Paid Amount")
                end;
...

        {
            ...
            begin
                if gl.Get("Vote Head") then
                    Rec."Votehead Name" := gl.Name;
