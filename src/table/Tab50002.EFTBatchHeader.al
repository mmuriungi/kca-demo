table 50002 "EFT Batch Header"
{
    // DrillDownPageID = 68227;
    // LookupPageID = 68227;
    ...
    begin
        ...
        IF "No." = '' THEN BEGIN
            ...
            NoSeriesMgt.InitSeries(GenLedgerSetup."EFT Batch No", xRec."No. Series", 0D, "No.", "No. Series");
        END;
