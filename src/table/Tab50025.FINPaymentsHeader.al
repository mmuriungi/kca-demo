table 50025 "FIN-Payments Header"
{
    DrillDownPageID = "FIN-Payment Vouchers";
    LookupPageID = "FIN-Payment Vouchers";
    ...
    fields
    {
        ...
        field(50161; "Total Witholding Vat Amount"; Decimal)
        {
        ...
        {
            OptionMembers = " ","M-Pesa",Cash,Cheque,EFT,"Letter of Credit","Custom 3","Custom 4","Custom 5";
        }
        ...
        {
            // FieldClass = FlowField;
            // CalcFormula = sum("FIN-Payment Line"."Budgeted Amount" where(No = field("No.")));
            // Editable = false;
        ...
        field(50005; "Budget Balance"; Decimal)
        {
            // Editable = false;
            // FieldClass = FlowField;
            // CalcFormula = sum("FIN-Payment Line"."Budget Balance" where(No = field("No.")));
        }
        ...
        field(50162; "Payment Schedule No"; Code[30])
        {
            DataClassification = ToBeClassified;
        }
        field(50163; "Tax Voucher"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(50164; "Tax Type"; Option)
        {
            Caption = 'Tax Type';
            OptionMembers = " ","W/Tax",VAT,Excise,Others,Retention,PAYE,Commision;
        }
        field(50165; "Cheque Buffer No"; code[20])
        {
            TableRelation = "FIN-Cheaque Collection Header"."No." where(Closed = filter(false));

        }
        field(50166; "Imprest Voucher"; Boolean)
        {
