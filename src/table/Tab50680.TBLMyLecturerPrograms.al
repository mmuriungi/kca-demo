table 50680 TBLMyLecturerPrograms
{
    Caption = 'TBLMyLecturerPrograms';
    DataClassification = ToBeClassified;
    LookupPageId = TBLMyLecturerPrograms;
    DrillDownPageId = TBLMyLecturerPrograms;
    ...
    keys
    {
        key(PK; UserCode, StaffNo, ProgrammeCode, "Semester")
        {
            Clustered = true;
        }
    }
