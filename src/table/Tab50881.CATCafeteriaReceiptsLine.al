table 50881 "CAT-Cafeteria Receipts Line"
{
    ...
    var
        rects: Record "CAT-Cafeteria Receipts";
        det: Record "CAT-Cafeteria Receipts Line";
        MealInvent: Record "CAT-Cafeteria Item Inventory";
}
