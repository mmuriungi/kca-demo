...
/// </summary>
table 50912 "ELECT-Candidates Applications"
{
    ...
    fields
    {
        ...
        {
            DataClassification = ToBeClassified;
            TableRelation = "ELECT-Voter Register"."Voter No." WHERE("Election Code" = FIELD("Election Code"), "Voter Verified" = const(true));
    ...
    var
        ...
        ELECTCandidatesApplications: Record "ELECT-Candidates Applications";
}
