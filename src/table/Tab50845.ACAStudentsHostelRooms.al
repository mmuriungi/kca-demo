table 50845 "ACA-Students Hostel Rooms X"
{
    ...
    fields
    {
                ...
                IF courseReg.FIND('-') THEN BEGIN
                    IF prog.GET(courseReg.Programmes) THEN BEGIN
                        ...
                        ELSE
                            ...
                            ELSE
                                IF courseReg."Settlement Type" = 'PSSP' THEN
        ...
        field(4; "Hostel No"; Code[20])
        {
            ...
            trigger OnValidate()
            var
                htlcard: Record "ACA-Hostel Card";
            ...
            begin
                ...
                htlcard.Reset();
                htlcard.SetRange("Asset No", "Hostel No");
                if htlcard.Find('-') then begin
                    htlcard.TestField("JAB Fees");
                    Charges := htlcard."JAB Fees";
                end;

                acasem.Reset();
                acasem.SetRange("Current Semester", true);
                if acasem.FindLast then begin
                    Rec.Semester := acasem.Code;
                    Rec."Academic Year" := acasem."Academic Year";
                end;
        ...
        field(500006; EMAIL; CODE[130])
        {

            CalcFormula = Lookup(Customer."E-Mail" WHERE("No." = FIELD(Student)));
            FieldClass = FlowField;
        }
