table 52501 "TT-Timetable Collector Singles"
{
    ...
    keys
    {
        ...
        key(Key2; Programme, Unit, Semester, "Lesson Code", "Day of Week", Lecturer, "Room Code", "Lesson Category", "Record ID")
        {
            Clustered = true;
        }
