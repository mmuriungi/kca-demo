table 50990 "HRM-Absence and Holiday"
{
    ...
    fields
    {
        ...
        field(2; "Start Date"; Date)
        {
            ...
            trigger OnValidate()
            var
                "lRec Employee": Record "HRM-Employee C";
...
//                    Cost:= "Days Lost" * emp."Daily Rate";
        ...
        {
            CalcFormula = Exist("HRM-Human Resource Comments" WHERE("Table Name" = CONST("Absence and Holiday"),
    ...
    var
        //todo CompPayPer: Record "HRM-Company Pay Periods";
