table 50555 "ACA-Course Registration"
{
    DrillDownPageID = "ACA-Course Registration List";
    LookupPageID = "ACA-Course Registration List";
    ...
    fields
    {
        field(1; "Student No."; Code[20])
        {
            ...
            begin
                ...
                if ((Rec.Semester = xRec.Semester) AND (Rec."Academic Year" = xRec."Academic Year")
                ) then begin
                    if Posted = TRUE then
                    ...
                    IF "Settlement Type" <> '' THEN BEGIN
                        IF "Register for" = "Register for"::Stage THEN BEGIN
                            ...
                            IF NOT FeeByStage.FIND('-') THEN BEGIN
                                ...
                                ERROR('No fees structure defined for the settlement type!. - ' + Programmes + ' - ' + Stage);
                                //"Audit Issue":=TRUE;
                                //MODIFY;
                                //
                                //"Settlement Type":='';
...
#pragma warning restore AL0603
        ...
        field(60195; "Date Posted"; Date)
        {

        }
        field(60196; "Posted By"; Code[20])
        {
    ...
    begin
        ...
        cust.setfilter(Status, '%1|%2', cust.Status::Current, Cust.Status::Registration);
        if not cust.find('-') then ERROR('Your status is not Current, Liase with The Registra');
    ...
    var
        ...
        coReg1: Record "ACA-Course Registration";
        ...
        EStageUnits: Record "ACA-External Units/Subjects";
        ...
        Programmz: Record "ACA-Programme";
        ...
        PStage: Record "ACA-Programme Stages";
        SFee: Record "ACA-Fee By Stage";
        ...
        MultipleCombination: Record "ACA-Units Options Combination";
        // HostLedger: Record "ACA-Hostel Ledger";
        //HostStudent: Record "ACA-Students Hostel Rooms";
        StudentUnits_2: Record "ACA-Student Units";
