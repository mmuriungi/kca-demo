table 51277 "ACA-Prog/Stage/Unit Sem. Sche."
{
    Caption = 'ACA-Prog/Stage/Unit Sem. Sche.';
    ...
    fields
    {
        ...
        field(25; "Unit Code"; Code[20])
        {
            Caption = 'Unit Code';
        }
        field(26; "Loaded Schedules"; Integer)
        {
            Caption = 'Loaded Schedules';
        }
        field(27; "Supplementary Entry Deadline"; Date)
        {
            Caption = 'Supplementary Entry Deadline';
        }
        field(28; "Buffer Results"; Boolean)
        {
