table 50159 "PROC-Procurement Plan Header1"
{
    ...
    fields
    {
        ...
        field(3; "Budgeted Amount"; Decimal)
        {
            ...
            CalcFormula = sum("PROC-Procurement Plan Lines1".Amount where("Budget Name" = field("Budget Name"), "Global Dimension 1 Code" = field("Global Dimension 1 Code")));
        }
        ...
        field(6; "Global Dimension 2 Code"; Code[20])
        {
            ...
            TableRelation = "Dimension Value".Code WHERE("Global Dimension No." = CONST(2),
                                                          Blocked = CONST(false), "Falls Under" = field("Global Dimension 1 Code"));
        }
    ...
    var
        procLines: Record "PROC-Procurement Plan Lines1";
