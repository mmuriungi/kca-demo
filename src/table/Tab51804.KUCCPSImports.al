...
table 51804 "KUCCPS Imports"
{
    ...
    fields
    {
        ...
        field(75; Faculty; text[150])
        {

        }
        field(5; Names; Text[300])
        {
        }
        ...
        field(103; "Resent E-mail"; Boolean)
        {

        }
        field(104; "Middle Name"; Text[100])
        {

        }
        field(105; "Other Name"; Text[100])
        {

        }
        // field(106; "School"; Text[100])
        // {
        //     CalcFormula = Lookup("ACA-Programme"."Faculty Name" WHERE(Code = FIELD(Prog)));
        //     FieldClass = FlowField;
        // }
        field(107; "Programme Name"; Text[100])
        {
            CalcFormula = Lookup("ACA-Programme".Description WHERE(Code = FIELD(Prog)));
            FieldClass = FlowField;
        }
    }
