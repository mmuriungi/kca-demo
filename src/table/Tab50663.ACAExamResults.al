/// <summary>
/// Table ACA-Exam Results (ID 51984).
/// </summary>
table 50663 "ACA-Exam Results"
{
    ...
    fields
    {
        ...
        field(5; Score; Decimal)
        {
            ...
            begin
                ...
                IF Course_Reg.FIND('-') THEN BEGIN
                    SETCURRENTKEY("Student No.", Programmes, Stage, Unit, Semester, ExamType, "Reg. Transaction ID", "Entry No");
                    IF RENAME("Student No.", Programmes, Stage, Unit, Semester, ExamType, Course_Reg."Reg. Transacton ID", "Entry No") THEN;
                ...
                IF Course_Reg.FIND('-') THEN BEGIN
                    ...
                    IF stud_Units.FIND('-') THEN BEGIN
                        ...
                        stud_Units.Grade := GetGrade(0, 0, stud_Units."Total Marks", Course_Reg.Programmes);
                        ...
                        IF ((stud_Units."CATs Marks Exists") AND (stud_Units."EXAMs Marks Exists" = FALSE)) THEN
                            consPref := 'c'
                        ELSE IF ((stud_Units."CATs Marks Exists" = FALSE) AND (stud_Units."EXAMs Marks Exists")) THEN
                            consPref := 'e'
                        //
                        ELSE IF ((stud_Units."CATs Marks Exists" = FALSE) AND (stud_Units."EXAMs Marks Exists" = FALSE)) THEN
                            consPref := 'x';
                        ...
                        IF ACAUnitsSubjects.FIND('-') THEN BEGIN
                            ...
                            END ELSE BEGIN
                                stud_Units.CALCFIELDS(stud_Units."Total Score");
                                stud_Units.Units := 3;
                                stud_Units."Weighted Units" := 3 * stud_Units."Total Score";
                            END;
                        END;
        ...
        field(24; "User Code"; Code[50])
        {
        }
        // field(25; Userid; Code[50])
        // {
        // }
        ...
        field(63030; "Last Modified by"; code[50])
        {
            Editable = false;
        }
        field(63031; "Date Last Modified"; Date)
        {
            Editable = false;
        }
        field(63032; "Time Last Modified"; time)
        {
            Editable = false;
        }
        //User_ID
    ...
    begin
        if NOT (Userid = 'FRANKIE') then Error('Access denied!');
    end;

    trigger OnModify()
    begin
        if (xRec.Unit <> Rec.Unit) then
            ERROR('Please note that modification of Units is not allowed');

        Rec."Last Modified by" := UserId;
        Rec."Date Last Modified" := TODAY;
        Rec."Time Last Modified" := System.Time;
    end;
    ...
    var
        ...
        UnitsRegister: Record "ACA-Units/Subjects";
        ACAExamResults2: Record "ACA-Exam Results";
        ACASemesters: Record "ACA-Semesters";

    /// <summary>
    /// GetGrade.
    /// </summary>
    /// <param name="CAT1">Decimal.</param>
    /// <param name="CAT2">Decimal.</param>
    /// <param name="FinalM">Decimal.</param>
    /// <param name="prog">Code[100].</param>
    ...
    var
        ...
        UnitsCourses: Record "ACA-Units/Subjects";
    ...
    /// CourseRegANDUggnits.
    /// </summary>
    /// <param name="StudNos">Code[50].</param>
    /// <param name="Progys">Code[50].</param>
    /// <param name="Semz">Code[50].</param>
    /// <param name="AcadYear">Code[50].</param>
    /// <param name="UnitzCode">Code[50].</param>
    /// <param name="stagez">Code[50].</param>
    ...
    var
        ...
        courseReg2: Record "ACA-Course Registration";
