...
/// </summary>
table 52407 "Lect Load Batch Lines"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = Lookup("HRM-Employee C"."Cellular Phone Number" WHERE("No." = FIELD("Lecturer Code")));
            FieldClass = FlowField;
        }
...
#pragma warning restore AL0603
    ...
    var
        LectLoadBatches: Record "Lect Load Batches";
        LectLoadCustProdSource: Record "ACA-Lecturers Units";
        LectLoadPermissions: Record "Lect Load Permissions";
