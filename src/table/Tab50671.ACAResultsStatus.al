table 50671 "ACA-Results Status"
{
    DrillDownPageID = "ACA-Senate Report Lubrics";
    LookupPageID = "ACA-Senate Report Lubrics";
    ...
    fields
    {
        ...
        field(63021; "Summary Page Caption"; Text[50])
        {
        }
        ...
        field(63029; "Academic Year Text"; Text[50])
        {
        }
    ...
    // trigger OnDelete()
    // begin
    //     IF ((USERID <> 'WANJALA') AND (USERID <> 'APPK1\ADMINISTRATOR')) THEN ERROR('ACCESS DENIED');
    // end;
