table 50157 "PROC-Internal Req. Plan Line"
{
    ...
    fields
    {
        ...
        field(19; "Vote Book"; Code[20])
        {
            ...
            begin
                ...
                CommitmentEntries.SETCURRENTKEY(CommitmentEntries."G/L Account No.");
                CommitmentEntries.SETRANGE(CommitmentEntries."G/L Account No.", "Vote Book");
    ...
    var
        ...
        CommitmentEntries: Record "FIN-Budget Entries";
        date: Date;
