table 50691 "Parttime Claim Header"
{
    ...
    begin
        ...
        IF "No." = '' THEN BEGIN
            GenLedgerSetup.GET;
            GenLedgerSetup.TESTFIELD(GenLedgerSetup."Parttime Claim Nos");
            ...
            NoSeriesMgt.InitSeries(GenLedgerSetup."Parttime Claim Nos", xRec."No. Series", 0D, "No.", "No. Series");
        ...
        IF FINBudgetEntries.FIND('-') THEN BEGIN
            IF FINBudgetEntries.CALCSUMS(Amount) THEN BEGIN
                IF FINBudgetEntries.Amount > 0 THEN BEGIN
                    ...
                    PostBudgetEnties.CheckBudgetAvailability("Expense AC", Rec.Date, Rec."Global Dimension 1 Code", Rec."Global Dimension 2 Code",
                    "Payment Amount", "Expense Ac Name", 'PartTime', Rec."No." + "Expense AC", Rec.Payee, rec.payee);
                END ELSE
    ...
    begin
        ...
        IF ("Payment Amount" > 0) THEN BEGIN
            ...
            PostBudgetEnties.ExpenseBudget("Expense AC", Rec.Date, Rec."Global Dimension 1 Code", Rec."Global Dimension 2 Code",
            "Payment Amount", "Expense Ac Name", USERID, TODAY, 'PartTime', Rec."No." + "Expense AC", Payee, Rec.payee);
        END;
    END;
