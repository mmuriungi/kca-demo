table 52492 "ACA-Exam Results (Cancelled)"
{
    ...
    fields
    {
        ...
        field(5; Score; Decimal)
        {
            ...
            trigger OnValidate()
            var
                ACAExamResults: Record "ACA-Exam Results (Cancelled)";
    ...
    var
        ...
        EResults: Record "ACA-Exam Results (Cancelled)";
        ...
        ACAExamResults2: Record "ACA-Exam Results (Cancelled)";
