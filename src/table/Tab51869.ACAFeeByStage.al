table 51869 "ACA-Fee By Stage"
{
    DrillDownPageID = "ACA-Fee By Stage";
    LookupPageID = "ACA-Fee By Stage";
    ...
    keys
    {
        key(Key1; "Programme Code", "Stage Code", Semester, "Student Type", "Settlemet Type", "Seq.")
        {
        }
    }
