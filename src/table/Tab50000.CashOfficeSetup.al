table 50000 "Cash Office Setup"
{
    ...
    fields
    {
        ...
        field(50050; "Payment Schedule No."; Code[20])
        {
            Caption = 'EFT Batch';
            DataClassification = ToBeClassified;
            TableRelation = "No. Series".Code;
        ...
        field(50054; "Surrender Dates"; Integer)
        {

        }

        field(50055; "Memo Nos."; Code[20])
        {
            TableRelation = "No. Series".code;

        }
        field(50056; "Interest G/l Acc"; Code[20])
        {
            TableRelation = "G/L Account"."No.";

        }
        field(50057; "Interest %"; Decimal)
        {
            // TableRelation = "G/L Account"."No.";

        }
        field(50058; "Cheque Buffer No"; code[20])
        {

            TableRelation = "No. Series".code;

        }
        field(50059; "Virement Nos"; code[20])
        {
            TableRelation = "No. Series".code;

        }
        field(50060; "FA Movement Nos"; code[20])
        {
            TableRelation = "No. Series".code;

        }
        field(50061; "Inclusive of Sunday"; Boolean)
        {


        }
        field(50062; "Inclusive of Saturday"; Boolean)
        {



        }
        field(50063; "Inclusive of Non Working Days"; Boolean)
        {



        }
        field(50064; "Budget Nos"; code[20])
        {
            TableRelation = "No. Series".code;
