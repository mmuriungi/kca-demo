table 51313 "Unit Exam Paper Submission"
{
    Caption = 'Unit Exam Paper Submission';
    ...
    fields
    {
        ...
        field(3; "Code"; Code[20])
        {
            ...
            //             "Default Exam Category" := ACAProgramme."Exam Category";
            //             Rec.Validate("Default Exam Category");
            //         end;
            //     end;
            //end;
        ...
        field(50031; "Last Modified by"; code[50])
        {
            Editable = false;
        }
        field(50032; "Date Last Modified"; Date)
        {
            Editable = false;
        }
        field(50033; "Time Last Modified"; time)
        {
            Editable = false;
        }
        ...
        field(50039; "Submission Time"; Time)
        {
            Editable = false;
        }
    ...
    keys
    {
        key(Key1; "Code", "Programme Code", "Stage Code", "Entry No", semester)
        {
        }
        key(Key2; "Stage Code")
        {
