table 52003 "Deposit Header"
{
    ...
    trigger OnInsert()
    begin
        if FINCashOfficeUserTemplate.Get(UserId) then begin
            //"Journal Template Name" := GETRANGEMAX("Journal Template Name");
            //"Journal Batch Name" := GETRANGEMAX("Journal Batch Name");
            GenJnlLine.SetRange("Journal Template Name", FINCashOfficeUserTemplate."Receipt Journal Template");
            GenJnlLine.SetRange("Journal Batch Name", FINCashOfficeUserTemplate."Receipt Journal Batch");
    ...
    var
        ...
        DimMgt: Codeunit DimensionManagement2;
    ...
    begin
        ...
        GLSetup.Get;
        GLSetup.TestField("Deposit Nos.");
        if NoSeriesMgt.SelectSeries(GLSetup."Deposit Nos.", OldDepositHeader."No. Series", DepositHeader."No. Series") then begin
            NoSeriesMgt.SetSeries(DepositHeader."No.");
            Rec := DepositHeader;
            exit(true);
        end;
        exit(false);
