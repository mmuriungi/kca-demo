table 50023 "FIN-InterBank Transfers"
{
    DrillDownPageID = "FIN-Bank & Cash Trans. Req. UP";
    LookupPageID = "FIN-Bank & Cash Trans. Req. UP";
    ...
    fields
    {
        ...
        field(21; "Source Department Code"; Code[20])
        {
            ...
            trigger OnValidate()
            begin
                "Receiving Depot Code" := "Source Department Code";
            end;
        }
        ...
        field(93; Status; Option)
        {
            ...
            OptionMembers = Open,Pending,"Pending Approval",Approved,Cancelled,Released,Posted;
        }
