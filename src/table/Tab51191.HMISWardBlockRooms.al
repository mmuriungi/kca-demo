table 51191 "HMIS Ward Block Rooms"
{
    ...
    fields
    {
        ...
        field(2; "Room Code"; Code[20])
        {
            ...
            begin
                Ward.RESET;
                Ward.SETRANGE(Ward."Asset No", "Ward Code");
                IF Ward.FIND('-') THEN BEGIN
                    "Room Cost" := Ward."Cost Per Occupant";
                END;
            end;
        }
        field(3; "Bed Spaces"; Integer)
        {
            /* CalcFormula = Count("HMIS Room Spaces" WHERE (Ward Code=FIELD(Ward Code),
        ...
        {
            /* CalcFormula = Count("HMIS Ward Ledger" WHERE (Ward No=FIELD(Ward Code),
                ...
                END ELSE
                    ...
                    END ELSE
                        IF "Occupied Spaces" = "Bed Spaces" THEN BEGIN
                            ...
                            MODIFY;
                        END ELSE
                            IF "Occupied Spaces" > "Bed Spaces" THEN ERROR('You can not allocate more than the available spaces!');
            end;
        }
