table 50034 "FIN-Staff Claims Header"
{
    ...
    fields
    {
        ...
        field(35; Status; Option)
        {
            ...
            OptionMembers = Open,Pending,"Pending Approval",Approved,Released,Posted,Cancelled;
        }
        ...
        {
            CalcFormula = Sum("FIN-Staff Claim Lines".Amount WHERE(No = FIELD("No.")));
            Editable = false;
            FieldClass = FlowField;
        }
        ...
        {
            CalcFormula = Sum("FIN-Staff Claim Lines"."Amount LCY" WHERE(No = FIELD("No.")));
            Editable = false;
            FieldClass = FlowField;
        }
        ...
        field(91; "Requested Amount"; Decimal)
        {
        }
        field(92; "Cheque Printed"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(93; "Imprest No."; code[20])
        {


        }
        field(94; "Surrender No."; code[20])
        {
