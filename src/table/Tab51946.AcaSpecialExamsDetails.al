table 51946 "Aca-Special Exams Details"
{
    ...
    fields
    {
        ...
        field(7; "Unit Code"; Code[20])
        {
            ...
            //                     ACAStdCharges.Description := 'Unit Billing: ' + ACAUnitsSubjects.Desription;
            ...
            REPEAT
                ...
                IF Charges."G/L Account" <> ' ' THEN
                    IF Customersz.GET("Student No.") THEN BEGIN
                        ...
                        GenJnl.Description := 'Resit Billing for ' + ACAUnitsSubjects.Code + ': ' + ACAUnitsSubjects.Desription;
                        GenJnl."Account No." := Customersz."No.";
                        IF StudentCharges.Amount = 0 THEN StudentCharges.Amount := 1000;
                        ...
                        GenJnl.INSERT;
                    END;
                StudentCharges."Recovery Priority" := 25;
                StudentCharges.Recognized := TRUE;
                StudentCharges.MODIFY(true);
