table 51278 "ACA-Lecture Marks Permissions"
{
    Caption = 'ACA-Lecture Marks Permissions';
    ...
    fields
    {
        ...
        field(26; "Lecturer Code"; Code[50])
        {
            Caption = 'Lecturer Code';
        }
        field(27; "Lecturer Name"; Text[250])
        {
    ...
    keys
    {
        key(PK; "Code", "Unit Code", "Lecturer Code")
        {
            Clustered = true;
        }
    }
