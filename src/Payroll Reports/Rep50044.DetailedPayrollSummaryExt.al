report 50044 "Detailed Payroll Summary Ext"
{
    DefaultLayout = RDLC;
    RDLCLayout = './PayrollLayouts/Detailed Payroll Summary.rdlc';
    ...
    dataset
    {
        dataitem("PRL-Period Transactions";"PRL-Period Transactions")
        {
            ...
            column(HsLvyEmployer;HouseLevyEmployer)
            {
            }
            ...
            begin
                ...
                if "Dimension Value".Find('-') then begin
                  ...
                  if prPeriodTransactions."Transaction Code"='996' then
                    HouseLevyEmployer:="PRL-Period Transactions".Amount;
