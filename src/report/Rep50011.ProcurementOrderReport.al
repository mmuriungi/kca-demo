report 50011 "Procurement Order Report"
{
    Caption = 'Procurement Order Report';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/ProcurementOrderReport.rdl';
    dataset
    {
        dataitem(PurchaseHeader; "Purchase Header")
        {
            ...
            column(Amount_Including_VAT; PurchaseHeader."Amount Including VAT")
            {
            ...
            dataitem(PurchaseLine; "Purchase Line")
            {
                ...
                column(Amount_Inc_VAT; PurchaseLine."Amount Including VAT")
                {
            ...
            dataitem(AppEntry; "Approval Entry")
            {
                ...
                column(DateTimeSentforApproval_ApprovalEntry; AppEntry."Date-Time Sent for Approval")
                {
                }
            ...
            begin
                ...
                InitTextVariable;
                FormatNoText(NumberText, "Amount Including VAT", CurrencyCodeText);
