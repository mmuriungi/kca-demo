report 51805 "ACA-Student Balances Per Prog."
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/ACA-Student Balances Per Prog..rdl';
    ...
    var
        ...
        Schools: Record "Dimension Value";
        CompanyInformation: Record "Company Information";
        ProgCat: Option " ","Certificate ",Diploma,Undergraduate,Postgraduate,Professional,"Course List";
}
