report 51855 "Official Admission Letter -SS1"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Official Admission Letter -SS1.rdl';
    ...
    dataset
    {
        dataitem("ACA-Applic. Form Header"; "ACA-Applic. Form Header")
        {
            ...
            begin
                ...
                FacultyName := '';
                FacRec.RESET;
                FacRec.SETRANGE(FacRec.Code, "ACA-Applic. Form Header".School1);
                IF FacRec.FIND('-') THEN
                    FacultyName := FacRec.Name;

                StageRec.RESET;
                StageRec.SETRANGE(StageRec."Programme Code", "ACA-Applic. Form Header"."First Degree Choice");
                StageRec.SETRANGE(StageRec.Code, "ACA-Applic. Form Header"."Admitted To Stage");
