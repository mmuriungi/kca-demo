report 50406 "List By Study Mode & Gender"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/List By Study Mode & Gender.rdl';
    ...
    dataset
    {
        dataitem("ACA-Programme"; "ACA-Programme")
        {
            ...
            column(Title1; 'STUDENT POPULATION BY PROGRAMME, STUDY MODE, AND GENDER AS AT ' + FORMAT(TODAY, 0, 4) + ', ' + Semesters)
            {
            }
