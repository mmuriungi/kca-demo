report 50575 "Final Consolidate Marksheet 1"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/FinalConsolidateMarksheet1.rdl';

    dataset
    {
        dataitem("Fin. Consolid. Marksheet Cntrl"; "Fin. Consolid. Marksheet Cntrl")
        {
