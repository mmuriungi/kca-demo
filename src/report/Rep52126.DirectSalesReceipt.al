report 52126 "Direct Sales Receipt"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Direct Sales Receipt.rdl';
    ...
    dataset
    {
        dataitem("Sales Shipment Header"; "Sales Shipment Header")
        {
            ...
            column(ActualBalance; salesheader.Balance)
            {

            }
            column(cashamount; salesheader."Cash Amount")
            {
