...
/// </summary>
report 51988 "Detailed Student Enrollment1"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Detailed Student Enrollment1.rdl';

    dataset
    {
        dataitem(DataItem3691; "ACA-Programme Stages")
        {
