report 52457 "ACA-Consolidated Gradesheet"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/ACA-Consolidated Gradesheet.rdl';
    ...
    var
        ...
        CummGPA2: Decimal;
        intK: Integer;
        studentsUnits: Record "ACA-Student Units";
        ...
        FacultyR: Record "ACA-Schools/Faculties";
        FDesc: Text[200];
        Dept: Text[200];
        PName: Text[200];
        SDesc: Text[200];
        ...
        constLine: Text[250];
        semesterDesc: Record "ACA-Academic Year Schedule";
