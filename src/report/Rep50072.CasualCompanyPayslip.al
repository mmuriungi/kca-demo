report 50072 "Casual-Company Payslip"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(DataItem1; "PRL-Casual Payroll Periods")
        {
            ...
            column(abreviation; 'LAKE BASIN DEVELOPMENT AUTHORITY.')
            {
            }
            ...
            begin
                ...
                prPeriod_Transactions.SETFILTER("Group Order", '=1|3|4|6|7|8|9|0');
                ...
                IF prPeriod_Transactions.FIND('-') THEN BEGIN
                    CLEAR(DetDate);
                    DetDate := FORMAT("Period Name") + ' (' + FORMAT(NoOfInstalment) + ')';
                    REPEAT
                    BEGIN
                        IF prPeriod_Transactions.Amount > 0 THEN BEGIN
                            ...
                            IF ((prPeriod_Transactions."Group Text" = 'TAXATION')) THEN
                                TAX := TAX + prPeriod_Transactions.Amount;
                            ...
                            END ELSE
                                IF (((prPeriod_Transactions."Group Order" = 7)
                                AND ((prPeriod_Transactions."Sub Group Order" <> 6)
                       AND (prPeriod_Transactions."Sub Group Order" <> 5))) OR
                       ((prPeriod_Transactions."Group Order" = 8) AND (prPeriod_Transactions."Sub Group Order" <> 9) OR
                       (prPeriod_Transactions."Group Order" = 6))) THEN BEGIN
                                    CLEAR(countz);
                                    // countz:=1;
                                    CLEAR(found);
            ...
            begin
                ...
                SETFILTER("Date Openned", '=%1', SelectedPeriod);
