report 52009 "Student ID"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Student ID.rdl';
    ...
    var
        ...
        genset: Record "ACA-General Set-Up";
        CountedStages: Integer;
        Progz: Record "ACA-Programme";
