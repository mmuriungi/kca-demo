report 52441 "Final Consolidated Marksheet"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Final Consolidated Marksheet.rdl';
    ...
    dataset
    {
        dataitem(DataItem1000000000; "ACA-Course Registration")
        {
            ...
            dataitem(StudUnitsz; "ACA-Student Units")
            {
    ...
    var
        ...
        counts: Integer;
        MksCounts: Record "ACA-Consolidated Mks Counts";
        MksCounts2: Record "ACA-Consolidated Mks Counts";
        pName: Text[250];
