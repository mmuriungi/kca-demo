report 50566 "EXT-Master Timetable (Final) 2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/EXT-Master Timetable (Final) 2.rdl';

    dataset
    {
        dataitem("EXT-Timetable FInal Collector"; "EXT-Timetable FInal Collector")
        {
