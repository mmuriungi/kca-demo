report 52178538 "Intangible Assets Register"
{
    ...
    dataset
    {
        ...
        {
            DataItemTableView = where("FA Class Code" = filter('INTANGIBLE'));
            ...
            column(VendorNo_FixedAsset; "Vendor No.")
            {
            }
            ...
            begin
                FixedAsset.SetFilter("FA Class Code", '%1', ClassCode);
                seq := 0;
            end;
