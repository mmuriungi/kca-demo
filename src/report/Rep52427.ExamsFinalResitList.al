report 52427 "Exams Final Resit List"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Exams Final Resit List.rdl';

    dataset
    {
        dataitem(SenateHeaders; "ACA-Senate Reports Header")
        {
            DataItemTableView = WHERE("Classification Code" = FILTER('RESIT LIST'));
            ...
            dataitem(ExamsCoreg; "ACA-Exam. Course Registration")
            {
                ...
                DataItemTableView = WHERE(Classification = FILTER('RESIT LIST'));
                ...
                dataitem(ExamRes; "ACA-Exam Classification Units")
                {
                ...
                begin
                    ...
                    IF ExamsCoreg."Final Year of Study" = ExamsCoreg."Year of Study" THEN BEGIN
                        finalists := TRUE;
                        Var4s := 'Examinations for the degree in their repective Programs and are recommended to resit' +
                        ' examinations in the courses indicated against their names when next offered';
                    END ELSE BEGIN
                        finalists := FALSE;
    ...
    var
        ...
        CourseCat: Text[100];
        ACASenateReportsCounts: Record "ACA-Senate Reports Counts" temporary;
