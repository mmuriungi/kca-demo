report 52025 "Population By Faculty"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Population By Faculty.rdl';

    dataset
    {
        dataitem(DataItem17; 349)
        {
            ...
            dataitem("ACA-Programme"; "ACA-Programme")
            {
                ...
                column(Title1; 'STUDENT POPULATION BY FACULTY - ' + Semesters)
                {
                }
                ...
                // column(DimName; "Dimension Value".Name)
                // {
                // }
