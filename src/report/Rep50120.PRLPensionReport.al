report 50120 "PRL-Pension Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/PRL-Pension Report.rdl';
    ...
    dataset
    {
        ...
        {
            DataItemTableView = WHERE("Transaction Code" = FILTER('pension'));
            ...
            dataitem("HRM-Employee C"; "HRM-Employee C")
            {
                ...
                begin
                    ...
                    PRLPeriodTransactions.SetRange(PRLPeriodTransactions."Transaction Code", 'D004');
        ...
        layout
        {
            area(content)
            {
                field(datefilter; datefilter)
                {
                    ApplicationArea = all;
                    Caption = 'Date:';
                    //TableRelation = "PRL-Period Transactions"."Period Month";
                }
            }
        }
