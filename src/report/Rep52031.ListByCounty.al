report 52031 "List By County"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/List By County.rdl';
    ...
    dataset
    {
        dataitem("ACA-Academics Central Setups"; "ACA-Academics Central Setups")
        {
            ...
            column(Title1; 'STUDENT LIST BY COUNTY,  ' + FORMAT(Semesters))
            {
            }
            column(pic; CompanyInfo.Picture)
            {
            }
            column(Progcode; "ACA-Academics Central Setups"."Title Code" + ': ' + "ACA-Academics Central Setups".Description)
            {
            }
            dataitem("ACA-Course Registration"; "ACA-Course Registration")
            {
                DataItemLink = "County Code" = FIELD("Title Code");
                column("Count"; cou)
                {
                }
