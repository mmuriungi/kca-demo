report 51859 "TMU Admission letter- Dip/Cert"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/TMU Admission letter- DipCert.rdl';
...
"ACA-Applic. Form Header"."First Choice Stage" = 'Y2S1' THEN
    ...
    var
        ...
        ttl: Text;
        repEndDate: Text;
        applicSet: Record "ACA-Applic. Setup";
        FeeByStage: Record "ACA-Fee By Stage";
        progCharges: Record "ACA-Stage Charges";
        counted: Integer;
