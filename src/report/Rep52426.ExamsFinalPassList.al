report 52426 "Exams Final Pass List"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Exams Final Pass List.rdl';

    dataset
    {
        dataitem(SenateHeaders; "ACA-Senate Reports Header")
        {
            DataItemTableView = WHERE("Classification Code" = FILTER('PASS LIST'));
            ...
            dataitem(ExamsCoreg; "ACA-Exam. Course Registration")
            {
                ...
                DataItemTableView = WHERE(Classification = FILTER('PASS LIST'));
