report 50394 "Norminal Roll (Cont. Students)"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Norminal Roll (Cont. Students).rdl';

    dataset
    {
        dataitem("ACA-Course Registration"; "ACA-Course Registration")
        {
            RequestFilterFields = Semester, "School Code", "Department Code", Programmes;
