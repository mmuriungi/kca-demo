report 51905 "Copy Fees Structure"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Copy Fees Structure.rdl';
    ...
    var
        FS: Record "ACA-Fee By Stage";
        FS2: Record "ACA-Fee By Stage";
        FS1: Record "ACA-Fee By Stage";
        SC1: Record "ACA-Stage Charges";
        SC2: Record "ACA-Stage Charges";
}
