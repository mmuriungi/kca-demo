report 50583 "Exams Final Halt List"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Exams Final Halt List.rdl';

    dataset
    {
        dataitem(SenateHeaders; "ACA-Senate Reports Header")
        {
            DataItemTableView = WHERE("Classification Code" = FILTER('HALT'));
            ...
            dataitem(ExamsCoreg; "ACA-Exam. Course Registration")
            {
                ...
                DataItemTableView = WHERE(Classification = FILTER('HALT'));
