report 50528 "Exams Final Cummulative Resit"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Exams Final Cummulative Resit.rdl';

    dataset
    {
        dataitem(ExamCoregcs; "ACA-Exam. Course Registration")
        {
            DataItemTableView = SORTING(Programme, "Programme Option", "Student Number") ORDER(Ascending) WHERE("Resit Exists" = FILTER(true));
