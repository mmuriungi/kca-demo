report 50664 "Gen. Customer Statement"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            column(OrderRoute; Customer.Countings)
            {
            }
            column(route; Customer.Countings)
            {
            }
    ...
    var
        ...
        t1: Label 'There will be no refunds until completion of your course and classification. Any queries to be addressed to Finance Officer';
        Faculty: Text[100];
