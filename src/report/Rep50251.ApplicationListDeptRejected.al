report 50251 "Application List Dept Rejected"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Application List Dept Rejected.rdl';

    dataset
    {
        dataitem(DataItem2953; "ACA-Applic. Form Header")
        {
            DataItemTableView = SORTING("Application No.")
                                WHERE(Status = CONST("Department Rejected"));
