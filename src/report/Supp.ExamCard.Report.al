...
Report 78088 "Supp. Exam Card"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Supp. Exam Card.rdlc';
    ...
    dataset
    {
        dataitem("aca-Course Registration"; "aca-Course Registration")
        {
            ...
            column(ShowSemester; ShowSemester)
            {
            }
            ...
            begin
                ...
                SpecialExams.SetRange(Category, SpecialExams.Category::Supplementary);
                ...
                if (bal > 0) and (j < studCount) then begin
                    ...
                    if i MOD 2 = 1 then begin
                        if j = studCount then begin
                            ...
                            col1Names := txtNames;
                            col1Bal := bal;
                            //  studStageSem:='SUPPLEMENTARY EXAM CARD';//'Stage: '+"ACA-Course Registration".Stage+'  Semester: '+"ACA-Course Registration".Semester;
                            ...
                            //SpecialExams.SETRANGE(Semester,"ACA-Course Registration".Semester);
                            SpecialExams.SetRange(Programme, "ACA-Course Registration".Programmes);
                            SpecialExams.SetRange(Category, SpecialExams.Category::Supplementary);
                            SpecialExams.SetRange(Status, SpecialExams.Status::Approved);
                            SpecialExams.SetRange("Charge Posted", true);
                        ...
                        if bal <= 0 then begin
                            ...
                            col2Names := txtNames;
                            col2Bal := bal;
                            //  studStageSem2:='SUPPLEMENTARY EXAM CARD';//'Stage: '+"ACA-Course Registration".Stage+'  Semester: '+"ACA-Course Registration".Semester;
