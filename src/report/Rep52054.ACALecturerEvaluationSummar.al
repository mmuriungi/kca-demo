report 52054 "ACA-Lecturer Evaluation Summar"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/ACA-Lecturer Evaluation Summar.rdl';
    ...
    var
        ACAEvaluationQuestions: Record "ACA-Evaluation Questions";
        ...
        DeptCode: Code[20];
        DeptName: Text[150];
        ACALecturersEvaluationCount: Record "ACA-Lecturers Evaluation Count";
}
