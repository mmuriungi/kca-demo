...
Report 66666 "Final Transcript"
{
    ...
    dataset
    {
        dataitem(Coregs; "ACA-Classification Course Reg.")
        {
            ...
            DataItemTableView = sorting("Student Number", Programme, "Year of Study", "Graduation Academic Year") order(ascending) where(Graduating = filter(true));
            ...
            begin
                ...
                TextedYos := ConvertDecimalToText.GetTextEquivalent(Format(Coregs."Year of Study"));
