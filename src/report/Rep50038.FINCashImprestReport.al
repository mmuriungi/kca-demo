report 50038 "FIN-Cash Imprest Report"
{
    Caption = 'FIN-Cash Imprest Report';


    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/CashImprestReport.rdl';
    ...
    dataset
    {
        dataitem(PaymentHeader; "FIN-Payments Header")
        {
            ...
            dataitem("<Payment Line>"; "FIN-Payment Line")
            {
                ...
                column(PaymentlineNo; No) { }
                column(Imprest_Request_No; "Imprest Request No") { }
                column(payee1; "Transaction Name") { }
            ...
            begin
                ...
                InitTextVariable;
                FormatNoText(NumberText, "Total Payment Amount", CurrencyCodeText);
