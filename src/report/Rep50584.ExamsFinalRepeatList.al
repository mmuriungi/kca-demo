/// <summary>
/// Report Exams Final Repeat List (ID 78046).
/// </summary>
report 50584 "Exams Final Repeat List"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Exams Final Repeat List.rdl';

    dataset
    {
        dataitem(SenateHeaders; "ACA-Senate Reports Header")
        {
            DataItemTableView = WHERE("Classification Code" = FILTER('REPEAT LIST'));
            ...
            dataitem(ExamsCoreg; "ACA-Exam. Course Registration")
            {
                ...
                DataItemTableView = WHERE(Classification = FILTER('REPEAT LIST'));
