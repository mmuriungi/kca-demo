report 52200 "Exam Buffer Processing"
{
    ProcessingOnly = true;
    ...
    dataset
    {
        dataitem(ExamBuff2; "ACA-Exam Results Buffer 2")
        {
            ...
            var
                yos: Integer;
            begin
                // if ExamBuff2."Student No." = '' then
                //     CurrReport.Skip() else if Semester = '' then
                //                           CurrReport.Skip() else if
                ...
                IF ExamBuff2.Stage = '' THEN BEGIN
                    ...
                    //   (GetUnitStageOnOffer(ExamBuff2."Unit Code", ExamBuff2.Programme, ExamBuff2.Semester)),
                    //   ExamBuff2.Intake, ExamBuff2."Exam Session") THEN BEGIN
                    // END;
                    // IF (GetUnitStageOnOffer(ExamBuff2."Unit Code", ExamBuff2.Programme, ExamBuff2.Semester)) = '' THEN
               ...
               END;*/
                    ...
                    // IF EVALUATE(yos, COPYSTR((GetUnitStageOnOffer(ExamBuff2."Unit Code", ExamBuff2.Programme, ExamBuff2.Semester)), 2, 1)) THEN BEGIN
                    // END;
                    //END;
                END;
                ...
                IF ExamBuff2.Semester = '' THEN BEGIN
                    IF (GetSemester(yos, ExamBuff2."Student No.", ExamBuff2."Unit Code",
                      ExamBuff2.Programme)) = '' THEN
                        ...
                        //    ExamBuff2."Unit Code", (GetUnitStageOnOffer(ExamBuff2."Unit Code", ExamBuff2.Programme, ExamBuff2.Semester)),
                        //    ExamBuff2.Intake, ExamBuff2."Exam Session") THEN BEGIN
                        //         END;
                        // ExamBuff2.MODIFY;
                    END;
                    ...
                    IF cust.FIND('-') THEN BEGIN
                        ...
                        IF progs.FIND('-') THEN BEGIN
                            ...
                            IF ProgStages.FIND('-') THEN BEGIN
                                ...
                                units.SETRANGE(units."Unit Code", ExamBuff2."Unit Code");
                                ...
                                END ELSE BEGIN // uNIT nOT eXISTS, CREATE ONE
                                    ...
                                    ExamBuff2.Stage, ExamBuff2."Unit Name", ExamBuff2.Semester);
                                    // Check if Course Reg Exists and Register Unit
                                    CourseRegANDUnits(ExamBuff2."Student No.", ExamBuff2.Programme,
                                    ExamBuff2.Semester, ExamBuff2."Academic Year",
                                    ExamBuff2."Unit Code", ExamBuff2.Stage);
    ...
    var
        ...
        //units: Record "ACA-Semester Units On Offer";
        units: Record "ACA-Units Master Table";
    ...
    var
        RegTransID: Code[20];
        // ACAUnitsSubjects: Record "ACA-Units/Subjects";
        //ACAUnitsSubjects: Record "ACA-Semester Units On Offer";
    ...
    begin
        ...
        courseReg.SETFILTER(Status, '%1|%2|%3', courseReg.Status::Current, courseReg.Status::Registration, courseReg.Status::Deceased);
        ...
        IF courseReg.FIND('-') THEN BEGIN
            ...
            IF NOT unitsReg.FIND('-') THEN BEGIN
                ...
                //ACAUnitsSubjects.SETRANGE("Unit Code", UnitzCode);
        ...
        END ELSE BEGIN
            ...
            coreg2.RESET;
            coreg2.SETRANGE(coreg2."Student No.", StudNos);
            ...
            IF NOT unitsReg.FIND('-') THEN BEGIN
                ...
                //ACAUnitsSubjects.SetRange(Semester, Semz);
                IF ACAUnitsSubjects.FIND('-') THEN BEGIN
                    unitsReg.INIT;
                    unitsReg.Programme := Progys;
                    unitsReg.VALIDATE(Stage, ACAUnitsSubjects."Stage Code");
                    unitsReg.Unit := UnitzCode;
                    unitsReg.Semester := Semz;
                    unitsReg.Units := 1;
                    unitsReg."Credit Hours" := 1;
    ...
    procedure CreateUnit(Progys: Code[50]; UnitzCode: Code[50]; stages: Code[50]; UnitName: Text[250]; sems: code[30])
    var
        unitsLis: Record "ACA-Units Master Table";
    begin
        // unitsLis.RESET;
        // unitsLis.SETRANGE(unitsLis."Unit Code", UnitzCode);
    ...
    begin
        ...
        coreg.SETRANGE(coreg.Programmes, Progy);
    ...
    // local procedure GetUnitStageOnOffer(UnitCodezz: Code[20]; Progzz: Code[20]; sems: code[30]) StageCode: Code[20]
    // var
    //     ACAUnitsOnOffer: Record "ACA-Semester Units On Offer";
    // begin
    //     ACAUnitsOnOffer.RESET;
    //     ACAUnitsOnOffer.SETRANGE("Unit Code", UnitCodezz);
    //     ACAUnitsOnOffer.SETRANGE("Programme Code", Progzz);
    //     ACAUnitsOnOffer.SetRange(Semester, sems);
    //     IF ACAUnitsOnOffer.FIND('-') THEN BEGIN
    //         StageCode := ACAUnitsOnOffer."Stage Code";
    //     END;
    // end;
