report 50012 "Purchase Quote Request Report"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(DataItem2583; "PROC-Quotation Request Vendors")
        {
            RequestFilterFields = "Vendor No.";
            column(Quotation_Request_Vendors__Quotation_Request_Vendors___Document_No__; DataItem2583."Document No.")
            {
            }
            column(VendorName; DataItem2583."Vendor Name")
            {
            }
            ...
            column(Purchase_Quote_Header___Expected_Closing_Date_; DataItem2583."Expected Closing Date")
            {
            }
            ...
            column(MMUCaption; 'TOM MBOYA UNIVERSITY COLLEGE')
            {
            }
            ...
            dataitem("PROC-Quotation Request Vendors"; "PROC-Purchase Quote Header")
            {
                ...
                column(PostingDescription_PurchaseQuoteHeader; "PROC-Quotation Request Vendors"."Posting Description")
                {
                }
                column(ExpectedClosingDate_PurchaseQuoteHeader; "PROC-Quotation Request Vendors"."Expected Closing Date")
                {
                }
                column(DeptName; DeptName)
                {
                }
                dataitem(DataItem3368; "PROC-Purchase Quote Line")
                {
                    DataItemLink = "Document No." = FIELD("No.");
                    column(Purchase_Quote_Line__Purchase_Quote_Line___No__; DataItem3368."No.")
                    {
                    }
                    ...
                    column(Purchase_Quote_Line__Description_; "Description")
                    {
                    }
                ...
                begin
                    ...
                    DimRec.RESET;
                    DimRec.SETRANGE(DimRec.Code, "PROC-Quotation Request Vendors"."Shortcut Dimension 2 Code");
                    IF DimRec.FIND('-') THEN
            ...
            begin
                // vendor.RESET;
                // vendor.SETRANGE(vendor."No.", DataItem2583."Vendor No.");
                // IF vendor.FIND('-') THEN
                ...
                // Quote.RESET;
                // Quote.SETRANGE(Quote."No.", DataItem2583."Document No.");
    ...
    var
        ...
        kilimamboCaptionLbl: Label 'TOM MBOYA UNIVERSITY COLLEGE';
    ...
    begin
        DataItem2583.SETFILTER("Document Type", FORMAT(DocType));
        DataItem2583.SETFILTER("Document No.", "DocNo.");
    end;
}