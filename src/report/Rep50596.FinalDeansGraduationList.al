report 50596 "Final Deans Graduation List"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Final Deans Graduation List.rdl';

    dataset
    {
        dataitem(ClassHeader; "ACA-Classification Header")
        {
            CalcFields = "Pass Status Count", "Total Number of Students", "Faculty Status Count";
            DataItemTableView = WHERE("Pass Status" = FILTER('PASS'));
            PrintOnlyIfDetail = true;
            RequestFilterFields = "Graduation Academic Year", Faculty;
            ...
            column(SaltedExamStatusDesc; 'In the year ' + ClassHeader."Graduation Academic Year" + ' ' + SaltedExamStatusDesc)
            {
            }
            ...
            dataitem(ClassDet2; "ACA-Classification Details")
            {
                ...
                DataItemTableView = SORTING("Student No.", "Classification Code")
                                    ORDER(Ascending)
                ...
                column(counts; ClassDet2."Classification Serial")
                {
                }
                ...
                var
                    ACADGradStudPresidence: Record "ACAD-Grad. Stud. Presidence";
                begin
            ...
            begin
                ...
                IF Prog.FIND('-') THEN BEGIN
                    Dimensions2.RESET;
                    Dimensions2.SETRANGE(dimensions2.code, prog."Department Code", 'FACULTY');
                    Dimensions2.SETRANGE(dimensions2.Code, Prog."School Code");
                ...
                ACAResultsStatus.SETRANGE(ACAResultsStatus.Code, ClassHeader."Classification Code");
                SaltedExamStatusDesc := ClassHeader.Msg1;
                CLEAR(NoOfStudentInText);
                NoOfStudents := ClassHeader."Faculty Status Count";
    ...
    var
        ...
        CurrNo: Integer;
        YoS: Code[20];
        CReg33: Record "ACA-Course Registration";
    ...
    begin
        ...
        IF ClassHeader.GETFILTER(Faculty) = '' THEN ERROR('Missing Faculty');
                ...
                IF ACAProgrammeStages.FIND('-') THEN BEGIN
                    IF ((COPYSTR(ACAProgrammeStages.Code, 2, 1)) IN ['1', '2', '3', '4', '5', '6', '7']) THEN BEGIN
                        IF EVALUATE(YoSComputed, COPYSTR(ACAProgrammeStages.Code, 2, 1)) THEN BEGIN
                            ...
                            ITmCourseReg.SETRANGE(Programmes, Prog.Code);
    ...
    var
        ACACourseRegistration741: Record "ACA-Course Registration";
        SpecialReason: Text[150];
        failExists: Boolean;
        StatusOrder: Integer;
        statusCompiled: Code[50];
