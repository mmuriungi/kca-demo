report 51827 "Signed Norminal Role"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Signed Norminal Role.rdl';

    dataset
    {
        dataitem("ACA-Course Registration"; "ACA-Course Registration")
        {
            DataItemTableView = WHERE("First Time Student" = FILTER(true));
            column(Title1; 'SIGNED NORMINAL ROLL, ' + FORMAT(Semesters))
            {
            }
            column("Count"; cou)
            {
            ...
            column(DS; "ACA-Course Registration"."Fee Structure Exists")
            {
            }
    ...
    var
        ...
        "Unit/Subjects": Record "ACA-Units/Subjects";
        Semeters: Record "ACA-Semester";
        Hesabu: Integer;
        StudFilter: Code[10];
        ...
        acaYear: Code[50];
        Semesters: Code[50];
        courseRegst: Record "ACA-Course Registration";
