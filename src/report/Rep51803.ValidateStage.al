report 51803 "Validate Stage"
{
    ProcessingOnly = true;

    dataset
    {
        dataitem(AC; "ACA-Clearance Approval Entries")
        {
    ...
    var
        ClearLedgers: Record "ACA-Clearance Approval Entries";
        clearTemps: Record "ACA-Clearance templates";
        clearDept: Record "ACA-Clearance Dept. Approvers";
}
