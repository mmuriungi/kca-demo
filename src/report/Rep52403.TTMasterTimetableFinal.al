report 52403 "TT-Master Timetable (Final)"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/TT-Master Timetable (Final).rdl';

    dataset
    {
        dataitem("TT-Timetable FInal Collector"; "TT-Timetable FInal Collector")
        {
    ...
    var
        ...
        TTLegendProgrammes: Record "TT-Legend Programmes";
        TTLegendLecturers: Record "TT-Legend Lecturers";
