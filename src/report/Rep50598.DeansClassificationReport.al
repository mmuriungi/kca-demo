report 50598 "Deans Classification Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Deans Classification Report.rdl';
    ...
    dataset
    {
        dataitem(ClassHeader; "ACA-Classification Header")
        {
            ...
            begin
                ...
                CLEAR(progName);
                Prog.RESET;
                Prog.SETRANGE(Code, ClassHeader."Programme Code");
    ...
    var
        ...
        SaltedExamStatus: Code[1024];
        SaltedExamStatusDesc: Text;
        ACASenateReportStatusBuff: Record "ACA-Senate Report Status Buff.";
        CurrNo: Integer;
        YoS: Code[20];
        yosInt: Integer;
        ACAUnitsSubjects: Record "ACA-Units/Subjects";
