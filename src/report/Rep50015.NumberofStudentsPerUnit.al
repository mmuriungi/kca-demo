report 50015 "Number of Students Per Unit"
{
    ApplicationArea = All;
    Caption = 'Number of Students Per Unit';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Number of Students Per Unit.rdlc';
    PreviewMode = PrintLayout;
    dataset
    {
        dataitem(ACAStudentUnits; "ACA-Student Units")
        {
            RequestFilterFields = Programme, Semester, "Academic Year", Stage, "School Code";
