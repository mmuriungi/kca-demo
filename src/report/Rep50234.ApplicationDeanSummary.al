report 50234 "Application Dean Summary"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Application Dean Summary.rdl';
    ...
    var
        ...
        OtherQ: Text[250];
        Wexp: Text[250];
        OtherQRec: Record "ACA-Applic. Form Qualification";
        WexpRec: Record "ACA-Applic. Form Employment";
        Reqstr: array[50] of Text[200];
        AdmReq: Record "ACA-Admission Req. Narration";
        i: Integer;
        ProgName: Code[200];
