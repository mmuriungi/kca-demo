report 50490 "Receipt - Student-TEST1"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Receipt - Student-TEST1.rdl';

    dataset
    {
        dataitem(DataItem9528; "ACA-Receipt Items")
        {
    ...
    var
        ...
        Names: Text[200];
        RecItems: Record "ACA-Receipt Items";
        pCode: Code[20];
