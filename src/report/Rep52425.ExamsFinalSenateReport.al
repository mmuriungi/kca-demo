report 52425 "Exams Final Senate Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Exams Final Senate Report.rdl';

    dataset
    {
        dataitem(SenateHeaders; "ACA-Senate Reports Header")
        {
            DataItemTableView = WHERE("Programme Classification Count" = FILTER(<> 0));
            ...
            dataitem(ExamsCoreg; "ACA-Exam. Course Registration")
            {
                ...
                column(Var4; SenateHeaders."Status Msg4")
                {
                }
                column(IncludeVar5; SenateHeaders."IncludeVariable 5")
                {
                }
                column(Var5; SenateHeaders."Status Msg5")
                {
                }
                column(IncludeVar6; SenateHeaders."IncludeVariable 6")
                {
                }
                column(Var6; SenateHeaders."Status Msg6")
                {
                }
                ...
                dataitem(ExamUnits; "ACA-Exam Classification Units")
                {
                    ...
                    column(UnitCode; ExamUnits."Unit Code")
                    {
                    }
                    column(UnitDesc; ExamUnits."Unit Description")
                    {
                    }
                }
            ...
            begin
                ...
                IF ACAExamCourseRegistration.FIND('-') THEN BEGIN
                    ...
                    BEGIN
                        seq += 1;
                        ACAExamCourseRegistration."Record Count" := seq;
