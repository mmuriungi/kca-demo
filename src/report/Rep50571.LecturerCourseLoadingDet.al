report 50571 "Lecturer Course Loading Det."
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Lecturer Course Loading Det..rdl';

    dataset
    {
        dataitem(DataItem1000000000; "ACA-Programme")
        {
            ...
            dataitem(DataItem1000000060; "ACA-Programme Stages")
            {
                ...
                dataitem(DataItem1000000032; "ACA-Lecturers Units")
                {
    ...
    var
        ...
        "Lect Load Batch Lines": Record "Lect Load Batch Lines";
        filters: Text[1024];
        filters2: Text[1024];
        filters3: Text[1024];
}
