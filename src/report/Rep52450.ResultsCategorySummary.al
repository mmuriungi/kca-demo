report 52450 "Results Category Summary"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Results Category Summary.rdl';
    ...
    dataset
    {
        dataitem(AcaCoreg1; "ACA-Course Registration")
        {
            ...
            var
                ACASenateReportCounts44: Record "ACA-Senate Report Counts";
                countedList: Integer;
            begin
    ...
    var
        ...
        ACASenateReportCounts2: Record "ACA-Senate Report Counts";
        ...
        ACAResultsStatus2: Record "ACA-Results Status";
        Msg1: Text[250];
        Msg2: Text[250];
        Msg3: Text[250];
        Msg4: Text[250];
        ...
        yosInt: Integer;
        ACASenateReportPercentages: Record "ACA-Senate Report Percentages";
}
