report 50568 "Time Table"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Time Table.rdl';

    dataset
    {
        dataitem("ACA-Day Of Week"; "ACA-Day Of Week")
        {
            RequestFilterFields = "Programme Filter", "Stage Filter", "Campus Filter", "Unit Filter", "Class Filter", "Unit Class Filter", "Semester Filter", "Student Type", "Lecturer Filter", "Exam Filter", "Lecture Room Filter", "Department Filter";
...
#pragma warning restore AL0667
            ...
            begin
                ...
                TimeTable.SETFILTER(TimeTable."Campus Code", "ACA-Day Of Week".GETFILTER("ACA-Day Of Week"."Campus Filter"));
                                ...
                                END ELSE BEGIN
                                    IF STRLEN(T[Lessons."No."]) < 201 THEN
                                        T[Lessons."No."] := T[Lessons."No."] + '' + TimeTable.Programme + ',' + TimeTable.Stage
                                         ...
                                         + ' ' + TimeTable."Unit Class" + ' ________________';
                                END;
    ...
    var
        ...
        L: array[40] of Text[250];
        T: array[40] of Text[250];
        CellCont: Text[250];
        i: Integer;
