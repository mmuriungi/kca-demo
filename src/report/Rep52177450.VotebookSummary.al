report 50781 "Votebook Summary"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/VotebookSummary.rdlc';
    Caption = 'Budget vs Commitments Analysis';
        ...
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            begin
                ...
                IF GetRangeMin("Date Filter") = 0D then
                    ERROR('The Date filter must have a lower Bound!');
