report 52023 "Population By Prog. Category"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Population By Prog. Category.rdl';
    ...
    var
        "academic Year": Record "ACA-Academic Year";
        campus: Record "Dimension Value";
        info: Record "Company Information";
        student: Record "ACA-Course Registration";
