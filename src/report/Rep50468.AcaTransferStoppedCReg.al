report 50468 "Aca-Transfer Stopped C. Reg."
{
    ProcessingOnly = true;
    ...
    var
        ...
        ACAStudentUnitsReservour: Record "ACA-Student Units Reservour";
        ACAStdChargesReservour: Record "ACA-Std Charges Reservour";
}
