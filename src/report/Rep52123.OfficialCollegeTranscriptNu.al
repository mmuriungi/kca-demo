report 52123 "Official College Transcript Nu"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Official College Transcript Nu.rdl';

    dataset
    {
        dataitem(DataItem1000000000; "ACA-Course Registration")
        {
            ...
            column(YoS; "Supp. Year Of Study")
            {
            }
            column(TotalYearlyMarks; "Supp. Total Yearly Marks")
            {
            }
            column(YearlyAverage; "Supp. Yearly Average")
            {
            }
            column(YearlyGrade; "Supp. Yearly Grade")
            {
            }
            column(YearlyFailed; "Supp. Yearly Failed Units")
            {
            }
            column(YearlyTotalUnits; "Supp. Yearly Total Units Taken")
            {
            }
            column(YearlyRemarks; "Supp. Transcript Remarks")
            {
            }
            ...
            column(FacultyName; UPPERCASE(Faculty))
            {
            }
            ...
            dataitem(DataItem1000000005; "ACA-Student Units")
            {
                DataItemLink = "Student No." = FIELD("Student No."),
                               "Unit Year of Study" = FIELD("Year Of Study");
                DataItemTableView = WHERE("Supp. Grade" = FILTER(<> 'E'),
                                          "Reg Reversed" = FILTER('No'));
                column(Unit; Unit)
                {
                }
                ...
                begin
                    ...
                    units_Subjects.SETRANGE("Programme Code", Programme);
                    units_Subjects.SETRANGE(Code, Unit);
            ...
            begin
                ...
                IF "Yearly Remarks" <> '' THEN BEGIN
                    ...
                    ACAResultsStatus.SETRANGE(Code, COPYSTR("Yearly Remarks", 1, 50));
