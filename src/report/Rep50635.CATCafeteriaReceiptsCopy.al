report 50635 "CAT-Cafeteria Receipts (Copy)"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/CAT-Cafeteria Receipts (Copy).rdl';

    dataset
    {
        dataitem(DataItem1; "CAT-Cafeteria Receipts")
        {
            ...
            dataitem(DataItem2; "CAT-Cafeteria Receipts Line")
            {
