report 51882 "Shortlisted Students Summary"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Shortlisted Students Summary.rdl';
...
#pragma warning restore AL0667
    ...
    var
        ...
        PointsReqd: Integer;
        AdmStatus: Text[30];
        ProgGrade: Record "ACA-Programme Grades";
        SubGradeReqd: Code[20];
        SubjectStatus: Text[30];
        SubGrade: Record "ACA-Programme Subject Grade";
        SubPoints: Integer;
        recGrade: Record "ACA-Applic. Setup Grade";
