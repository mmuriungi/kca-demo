report 50006 "Petty Cash Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Petty Cash Voucher Report.rdl';
    ...
    dataset
    {
        dataitem("FIN-Payments Header"; "FIN-Payments Header")
        {
            ...
            column(TotalPayment_Amount; "FIN-Payments Header"."Total Net Amount")
            {
            ...
            begin
                ...
                ApprovalEntry1.SetRange("Document No.", "FIN-Payments Header"."No.");
                ...
                ApprovalEntry2.SetRange("Document No.", "FIN-Payments Header"."No.");
                ...
                ApprovalEntry3.SetRange("Document No.", "FIN-Payments Header"."No.");
                ...
                ApprovalEntry4.SetRange("Document No.", "FIN-Payments Header"."No.");
                ...
                ApprovalEntry5.SetRange("Document No.", "FIN-Payments Header"."No.");
    ...
    var
        ...
        name: Label 'TOM MBOYA UNIVERSITY COLLEGE';
        "name+": Label '';
        addr: Label '';
        email: Label '';
        PIN: Label 'PIN:';
