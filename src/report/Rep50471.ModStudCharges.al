report 50471 "Mod Stud Charges"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Mod Stud Charges.rdl';
...
#pragma warning restore AL0667
            ...
            begin
                ...
                IF "ACA-Std Charges"."Total Paid" > "ACA-Std Charges".Amount THEN BEGIN
                    RcptItems.RESET;
                    RcptItems.SETCURRENTKEY(RcptItems."Transaction ID", RcptItems."Student No.");
    ...
    var
        RcptItems: Record "ACA-Receipt Items";
