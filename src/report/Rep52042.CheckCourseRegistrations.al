report 52042 "Check Course Registrations"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Check Course Registrations.rdl';

    dataset
    {
        dataitem(DataItem1000000001; "ACA-Course Registration")
        {
    ...
    var
        ...
        "ACA-Programme": Record "ACA-Programme";
}
