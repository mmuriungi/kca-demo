report 50743 "Vendor/Item Statistics"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/VendorItem Statistics.rdl';
                ...
                begin
                    ...
                    if PurchInvHeader.FindFirst then
                        if PurchInvHeader."Order Date" > 0D then begin
                            "TotalQuantity-LT" := "Invoiced Quantity";
...
#pragma warning disable AL0667
                    CurrReport.CreateTotals("Invoiced Quantity", "Purchase Amount (Actual)", "Discount Amount", TotalDays, "TotalQuantity-LT");
