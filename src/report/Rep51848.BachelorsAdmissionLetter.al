report 51848 "Bachelors Admission Letter"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Official Admission LetterSSS.rdl';
    EnableHyperlinks = true;

    dataset
    {
        dataitem("Application Form Header"; "ACA-Applic. Form Header")
        {
            ...
            column(CampusLocation_ApplicationFormHeader; "Application Form Header".Campus)
            {
            }
            ...
            {
                DataItemLink = "Programme Code" = FIELD("First Degree Choice");
            ...
            begin
                ...
                ProgName := '';
                IF Prog1.GET("Application Form Header"."First Degree Choice") THEN BEGIN
                ...
                END;
                progFee.Reset();
                progFee.SetRange(progFee.ProgCode, "Application Form Header"."First Degree Choice");
                progFee.SetRange(progFee.settlementType, "Application Form Header"."Settlement Type");
                ...
                IF ("Application Form Header"."First Degree Choice" = 'BMED') OR ("Application Form Header"."First Degree Choice" = 'BSC NURSING') THEN
                    ReportDate := 20190322D ELSE
                    ReportDate := 20190321D;

                StageRec.RESET;
                StageRec.SETRANGE(StageRec."Programme Code", "Application Form Header"."First Degree Choice");
