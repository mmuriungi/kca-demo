report 50244 "Admission Academic Parcel"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Admission Academic Parcel.rdl';

    dataset
    {
        dataitem("ACA-Adm. Parcel Main"; "ACA-Adm. Parcel Main")
        {
    ...
    var
        AdmParc: Record "ACA-Adm. Parcel Main";
        LineNo: Integer;
        DeadLineDate: Date;
