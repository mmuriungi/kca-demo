report 50560 "Final Senate Classification"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Final Senate Classification.rdl';

    dataset
    {
        dataitem(ClassHeader; "ACA-Classification Students")
        {
            ...
            dataitem(ClassDet2; "ACA-Classification Units")
            {
    ...
    var
        ACACourseRegistration741: Record "ACA-Classification Students";
        SpecialReason: Text[150];
        failExists: Boolean;
        StatusOrder: Integer;
        statusCompiled: Code[50];
