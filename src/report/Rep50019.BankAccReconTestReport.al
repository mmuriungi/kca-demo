report 50019 "Bank Acc. Recon. - TestReport"
{
    ...
    dataset
    {
        dataitem(DataItem30; "Bank Acc. Reconciliation")
        {
            ...
            dataitem(BankAccountLedgerEntry; "Bank Account Ledger Entry")
            {
                ...
                begin
                    ...
                    SETFILTER("Posting Date", '%1..%2', 99990101D, BankAccReconciliation."Statement Date");
            ...
            dataitem(DataItem1000000002; "Bank Acc. Reconciliation Line")
            {
                DataItemLink = "Bank Account No." = FIELD("Bank Account No."),
                ...
                column(Difference_BankAccReconciliationLine; Difference)
                {
                }
                ...
                column(AdditionalTransactionInfo_BankAccReconciliationLine; "Additional Transaction Info")
                {
                }
            }
            dataitem(BankAccReconciliationLine1; "Bank Account Statement Line")
            {
                DataItemLink = "Bank Account No." = FIELD("Bank Account No."),
                               "Statement No." = FIELD("Statement No.");
            ...
            dataitem(BankAccReconciliationLine3; "Bank Account Statement Line")
            {
                DataItemLink = "Bank Account No." = FIELD("Bank Account No."),
                               "Statement No." = FIELD("Statement No.");
            ...
            begin
                ...
                IF Bank.FIND('-') THEN BEGIN
                    ...
                    */
                    ...
                    BankAccountLedgerEntry2.SETFILTER("Posting Date", '%1..%2', 99990101D, "Statement Date");
                    ...
                    BankStatBalance := "Statement Ending Balance";
                   ...
                   // BankAccReconciliationLine.SETRANGE(BankAccReconciliationLine.Type, BankAccReconciliationLine.Type::"Bank Account Ledger Entry");
                    ...
                    BankAccReconciliationLine2.SETRANGE(BankAccReconciliationLine2."Bank Account No.", "Bank Account No.");
                    BankAccReconciliationLine2.SETRANGE(BankAccReconciliationLine2."Statement No.", "Statement No.");
                  ...
                  UNTIL BankAccReconciliationLine2.NEXT = 0
                    ...
                    BankAccReconciliationLine1.SETRANGE(BankAccReconciliationLine1."Bank Account No.", "Bank Account No.");
                    BankAccReconciliationLine1.SETRANGE(BankAccReconciliationLine1."Statement No.", "Statement No.");
                    BankAccReconciliationLine1.SETFILTER(Difference, '<>%1', 0);
                ...
                myDifferences := ("Statement Ending Balance" - UnpresentedChequesTotal - DifferencesInBankTotalDebits + DifferencesInBankTotalCredits + UncreditedBanking) - (BankAccountBalanceasperCashBook);
    ...
    var
        ...
        BankAccReconciliationLine2: Record "Bank Account Statement Line";
