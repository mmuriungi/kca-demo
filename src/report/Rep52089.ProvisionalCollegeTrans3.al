report 52089 "Provisional College Trans. 3"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Provisional College Trans. 3.rdl';
    ...
    dataset
    {
        dataitem(DataItem1000000000; "ACA-Course Registration")
        {
            ...
            dataitem(StudUnitsss; "ACA-Student Units")
            {
    ...
    var
        ...
        Unitsz: Record "ACA-Units/Subjects";
