report 50523 "Graduation Progress Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Graduation Progress Report.rdl';
    ...
    dataset
    {
        dataitem(StudentsClassification; "ACA-Classification Students")
        {
            ...
            RequestFilterFields = "Graduation Academic Year", "School Code", "Student Number", Programme;
            ...
            dataitem(GradUnits; "ACA-Classification Units")
            {
