report 50534 "Official University Transcript"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Official Univerity Transcript.rdl';
    ...
    dataset
    {
        dataitem(CourseRegs; "ACA-Exam. Course Registration")
        {
            ...
            column(phones; CompanyInformation."Phone No.")
            {
            }
            ...
            trigger OnAfterGetRecord()
            begin
                /* CourseRegs.TestField("Academic Year");
                CourseRegs.TestField("Student Number"); */
                ...
                ACAClassificationUnits369.SETRANGE("Student No.", CourseRegs."Student Number");
                ACAClassificationUnits369.SETRANGE("Year of Study", CourseRegs."Year of Study");
                ACAClassificationUnits369.SETRANGE(Programme, CourseRegs.Programme);
                ...
                ACACourseRegistration369.SETRANGE("Student No.", CourseRegs."Student Number");
                ...
                IF ACACourseRegistration369.FIND('-') THEN BEGIN
                    ...
                    IF Sem.FIND('-') THEN BEGIN
                        ...
                        IF ACAAcademicYear369.FIND('-') THEN BEGIN
                            //CourseRegs."Admissions Date":=ACAAcademicYear369."Admission Date";
                            /*  IF ((prog.Category = prog.Category::Certificate) OR (prog.Category = prog.Category::"Course List") OR (prog.Category = prog.Category::Professional)) THEN BEGIN
                             ...
                             IF prog."Special Programme Class" = prog."Special Programme Class"::"Medicine & Nursing" THEN BEGIN
                                 ACAAcademicYear369.TESTFIELD("Graduation Date (Medicine)");
                             ...
                             IF prog."Special Programme Class" = prog."Special Programme Class"::Engineering THEN BEGIN
                                 ACAAcademicYear369.TESTFIELD("Graduation Date (Engineering)");
    ...
    var
        ACACourseRegistration369: Record "ACA-Course Registration";
        PExists: Boolean;
        gradDates: Date;
        ACAClassificationUnits369: Record "ACA-Classification Units";
        ACAAcademicYear369: Record "ACA-Academic Year";
