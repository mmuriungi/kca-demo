report 50674 "ELECT-Election Winners"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/ELECT-Election Winners.rdl';

    dataset
    {
        dataitem(ElectPositions; "ELECT-Positions")
        {
            ...
            dataitem(ElectCandidates; "ELECT-Candidates")
            {
                ...
                dataitem(ElectResRankings; "ELECT-Results Rankings")
                {
    ...
    var
        ...
        ElectResRankings2: Record "ELECT-Results Rankings";
        ELECTCandidates2: Record "ELECT-Candidates";
        ELECTPositionCategories: Record "ELECT-Position Categories";
}
