report 50509 "Sem. Grouped Fee Statement"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Sem. Grouped Fee Statement.rdl';
    Caption = 'Customer - Statement';

    dataset
    {
        dataitem(Customers; 18)
        {
            ...
            dataitem(DataItem8503; 21)
            {
                ...
                begin
                    ...
                    CLEAR(Semz);
                    ACASemesters.RESET;
                    ACASemesters.SETFILTER(ACASemesters.from, '=%1|<%2', ledge."Posting Date", ledge."Posting Date");
                    ACASemesters.SETFILTER(ACASemesters."To", '=%1|>%2', ledge."Posting Date", ledge."Posting Date");
                    IF ACASemesters.FIND('-') THEN BEGIN
                        Semz := ACASemesters.Description;
                    END;
