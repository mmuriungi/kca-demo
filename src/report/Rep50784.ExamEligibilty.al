report 50784 "Exam Eligibility"
{
    ApplicationArea = All;
    Caption = 'Exam Eligibility By Class Attendance';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/ExamEligibilty.rdlc';
    dataset
    {
        dataitem(ACAStudentUnits; "ACA-Student Units")
        {
            ...
            begin
                ...
                ClassAtt.Reset();
                ClassAtt.SETRANGE("Student No.", ACAStudentUnits."Student No.");
                ClassAtt.SETRANGE("Semester", ACAStudentUnits.Semester);
                ClassAtt.SetRange("Unit Code", ACAStudentUnits.Unit);
